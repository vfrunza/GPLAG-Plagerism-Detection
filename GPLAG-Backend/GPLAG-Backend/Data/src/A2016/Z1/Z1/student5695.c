...
int main() {
	...
	if(t>=6 && b>=6 && m>=6) printf("Sva tri studenta su polozila.\n");
	else if(t==5 && b==5 && m==5) {
	...
	if(t==m && m==b) printf("Sva tri studenta imaju istu ocjenu.\n");
	else if((t==m && m!=b) || (t==b && b!=m) || (b==m && m!=t)) printf("Dva od tri studenta imaju istu ocjenu.\n");
	else if(t!=m && m!=b && t!=b) printf("Svaki student ima razlicitu ocjenu.\n");
	return 0;
}
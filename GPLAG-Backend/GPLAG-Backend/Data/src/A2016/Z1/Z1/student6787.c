...
int main() {
	...
	if(zbir >= 54.999 && zbir < 65) ocjenaTarik = 6;
	else if (zbir >= 64.999 && zbir < 75) ocjenaTarik = 7;
	else if (zbir >= 74.999 && zbir < 85) ocjenaTarik = 8;
	else if (zbir >= 84.999 && zbir < 92) ocjenaTarik = 9;
	else if (zbir >= 91.999 && zbir < 100) ocjenaTarik = 10;
	else ocjenaTarik = 5;
	
	zbir = (bBojan1 + bBojan2 + prisustvoBojan + zadaceBojan + zavrsniBojan);
	if(zbir >= 54.999 && zbir < 65) ocjenaBojan = 6;
	else if (zbir >= 64.999 && zbir < 75) ocjenaBojan = 7;
	else if (zbir >= 74.999 && zbir < 85) ocjenaBojan = 8;
	else if (zbir >= 84.999 && zbir < 92) ocjenaBojan = 9;
	else if (zbir >= 91.999 && zbir < 100) ocjenaBojan = 10;
	else ocjenaBojan = 5;
	
	zbir = (bMirza1 + bMirza2 + prisustvoMirza + zadaceMirza + zavrsniMirza);
	if(zbir >= 54.999 && zbir < 65) ocjenaMirza = 6;
	else if (zbir >= 64.999 && zbir < 75) ocjenaMirza = 7;
	else if (zbir >= 74.999 && zbir < 85) ocjenaMirza = 8;
	else if (zbir >= 84.999 && zbir < 92) ocjenaMirza = 9;
	else if (zbir >= 91.999 && zbir < 100) ocjenaMirza = 10;
	else ocjenaMirza = 5;
	
	if(ocjenaTarik > 5) prolaz++;
	if(ocjenaBojan > 5) prolaz++;
	if(ocjenaMirza > 5) prolaz++;
	
	if(prolaz == 1) printf("Jedan student je polozio.");
	else if(prolaz == 2) printf("Dva studenta su polozila.");
	else if(prolaz == 3) printf("Sva tri studenta su polozila.");
	else {

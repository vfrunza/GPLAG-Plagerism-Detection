...
int main() {
	...
	if(prvi_parcijalni_ispit_t<0 || prvi_parcijalni_ispit_t>20) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("II parcijalni ispit: ");
	scanf("%f", &drugi_parcijalni_ispit_t);}
	if(drugi_parcijalni_ispit_t<0 || drugi_parcijalni_ispit_t>20) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Prisustvo: ");
	scanf("%f", &prisustvo_t);}
	if(prisustvo_t<0 || prisustvo_t>10) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Zadace: ");
	scanf("%f", &zadace_t);}
	if(zadace_t<0 || zadace_t>10) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Zavrsni ispit: ");
	scanf("%f", &zavrsni_ispit_t);}
	if(zavrsni_ispit_t<0 || zavrsni_ispit_t>40) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	...
	if(prvi_parcijalni_ispit_b<0 || prvi_parcijalni_ispit_b>20) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("II parcijalni ispit: ");
	scanf("%f", &drugi_parcijalni_ispit_b); }
	if(drugi_parcijalni_ispit_b<0 || drugi_parcijalni_ispit_b>20) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Prisustvo: ");
	scanf("%f", &prisustvo_b);}
	if(prisustvo_b<0 || prisustvo_b>10) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Zadace: ");
	scanf("%f", &zadace_b); }
	if(zadace_b<0 || zadace_b>10) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Zavrsni ispit: ");
	scanf("%f", &zavrsni_ispit_b); }
	if(zavrsni_ispit_b<0 || zavrsni_ispit_b>40) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	...
	if(prvi_parcijalni_ispit_m<0 || prvi_parcijalni_ispit_m>20){ printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("II parcijalni ispit: ");
	scanf("%f", &drugi_parcijalni_ispit_m); }
	if(drugi_parcijalni_ispit_m<0 || drugi_parcijalni_ispit_m>20){ printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Prisustvo: ");
	scanf("%f", &prisustvo_m);}
	if(prisustvo_m<0 || prisustvo_m>10) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Zadace: ");
	scanf("%f", &zadace_m);}
	if(zadace_m<0 || zadace_m>10) { printf("Neispravan broj bodova"); 
	return 0; }
	else {
	printf("Zavrsni ispit: ");
	scanf("%f", &zavrsni_ispit_m);}
	if(zavrsni_ispit_m<0 || zavrsni_ispit_m>40) { printf("Neispravan broj bodova"); 
	return 0; }
	else {

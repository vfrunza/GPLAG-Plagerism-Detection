...
int main() {
	...
	if(prva_parcijala1 < 0 || prva_parcijala1 > 20) { printf("Neispravan broj bodova"); return 0; }
	printf("II parcijalni ispit: ");
	scanf("%f", &druga_parcijala1);
	if(druga_parcijala1 < 0 || druga_parcijala1 > 20) { printf("Neispravan broj bodova"); return 0; }
	printf("Prisustvo: ");
	scanf("%f", &prisustvo1);
	...
	if(prva_parcijala2 < 0 || prva_parcijala2 > 20) { printf("Neispravan broj bodova"); return 0;}
	printf("II parcijalni ispit: ");
	scanf("%f", &druga_parcijala2);
	if(druga_parcijala2 < 0 || druga_parcijala2 > 20) { printf("Neispravan broj bodova"); return 0;}
	printf("Prisustvo: ");
	scanf("%f", &prisustvo2);
	if(prisustvo2 < 0 || prisustvo2 > 20) { printf("Neispravan broj bodova"); return 0; }
	printf("Zadace: ");
	scanf("%f", &zadace2);
	...
	if(prva_parcijala3 < 0 || prva_parcijala3 > 20) { printf("Neispravan broj bodova"); return 0; }
	printf("II parcijalni ispit: ");
	scanf("%f", &druga_parcijala3);
	if(druga_parcijala3 < 0 || druga_parcijala3 > 20) { printf("Neispravan broj bodova"); return 0;}
	printf("Prisustvo: ");
	scanf("%f", &prisustvo3);
	...
	if(ukupno1 >= 55 && ukupno2 >= 55 && ukupno3 >= 55) { printf("Sva tri studenta su polozila."); }
	...
	else if(ukupno1 < 55  && ukupno2 < 55  && ukupno3 < 55 ) { printf("Nijedan student nije polozio."); }
		
	if(ukupno1 >= 55 && ukupno1 < 65) ocjena1 = 6;
	else if(ukupno1 >= 65 && ukupno1 < 75) ocjena1 = 7;
	else if(ukupno1 >= 75 && ukupno1 < 85) ocjena1 = 8;
	else if(ukupno1 >= 85 && ukupno1 < 92) ocjena1 = 9;
	else if(ukupno1 >= 92) ocjena1 = 10;
	
	if(ukupno2 >= 55 && ukupno2 < 65) ocjena2 = 6;
	else if(ukupno2 >= 65 && ukupno2 < 75) ocjena2 = 7;
	else if(ukupno2 >= 75 && ukupno2 < 85) ocjena2 = 8;
	else if(ukupno2 >= 85 && ukupno2 < 92) ocjena2 = 9;
	else if(ukupno2 >= 92) ocjena2 = 10;
	
	if(ukupno3 >= 55 && ukupno3 < 65) ocjena3 = 6;
	else if(ukupno3 >= 65 && ukupno3 < 75) ocjena3 = 7;
	else if(ukupno3 >= 75 && ukupno3 < 85) ocjena3 = 8;
	else if(ukupno3 >= 85 && ukupno3 < 92) ocjena3 = 9;
	else if(ukupno3 >= 92) ocjena3 = 10;

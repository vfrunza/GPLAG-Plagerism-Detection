...
int main() {
	...
	printf ("\nI parcijalni ispit:");
	scanf ("%lf", &ppit);
	if (ppit<0 || ppit>20){printf (" Neispravan broj bodova");
		return 0;
	}
	...
	printf (" Prisustvo:");
	scanf ("%lf", &prt);
	if (prt<0 || prt>10) {printf (" Neispravan broj bodova");
		return 0;
	}
	printf (" Zadace:");
	scanf ("%lf", &dzt);
	if (dzt<0 || dzt>10) {printf (" Neispravan broj bodova");
		return 0;
	}
	...
	else if (bt>=92 && bt<=100) {ot=10;}
	
	printf (" Unesite bodove za Bojana:");
	printf ("\nI parcijalni ispit:");
	scanf ("%lf", &ppib);
	if(ppib<0 || ppib>20) {printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" II parcijalni ispit:");
	scanf ("%lf", &dpib);
	if (dpib<0 || dpib>20) { printf(" Neispravan broj bodova");
	return 0;
	}
	printf (" Prisustvo:");
	scanf ("%lf", &prb);
	if(prb<0 || prb>10) {printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" Zadace:");
	scanf ("%lf", &dzb);
	if(dzb<0 || dzb>10) {printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" Zavrsni ispit:");
	scanf ("%lf", &zib);
	...
	else if (bb>=92 && bb<=100) {ob=10;}
	
	printf (" Unesite bodove za Mirzu:");
	printf ("\nI parcijalni ispit:");
	scanf ("%lf", &ppim); 
	if (ppim<0 || ppim>20) {printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" II parcijalni ispit:");
	scanf ("%lf", &dpim);
	if (dpim<0 || dpim>20) {printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" Prisustvo:");
	scanf ("%lf", &prm);
	if (prm<0 || prm>10) {printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" Zadace:");
	scanf ("%lf", &dzm);
	if (dzm<0 || dzm>10) { printf (" Neispravan broj bodova");
	return 0;
	}
	printf (" Zavrsni ispit:");
	scanf ("%lf", &zim);

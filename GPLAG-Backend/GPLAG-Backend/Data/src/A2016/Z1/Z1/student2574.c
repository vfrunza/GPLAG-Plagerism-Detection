...
if (XT<55) TARIK=5;
if (55<=XT && XT<65) TARIK=6;
if (65<=XT && XT<75) TARIK=7;
if (75<=XT && XT<85) TARIK=8;
if (85<=XT && XT<92) TARIK=9;
if (92<=XT && XT <=100) TARIK=10;
if (XB<55) BOJAN=5;
if (55<=XB && XB<65) BOJAN=6;
if (65<=XB && XB<75) BOJAN=7;
if (75<=XB && XB<85) BOJAN=8;
if (85<=XB && XB<92) BOJAN=9;
if (92<=XB && XB <=100) BOJAN=10;
if (XM<55) MIRZA=5;
if (55<=XM && XM<65) MIRZA=6;
if (65<=XM && XM<75) MIRZA=7;
if (65<=XM && XM<85) MIRZA=8;
if (85<=XM && XM<92) MIRZA=9;
if (92<=XM && XM<=100) MIRZA=10;
}

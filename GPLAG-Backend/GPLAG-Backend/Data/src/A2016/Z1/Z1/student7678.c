...
int main() {
	...
	scanf("%lf",&pi1t);
	if(pi1t<0 || pi1t>20){printf("Neispravan broj bodova");return 0;}
	printf("II parcijalni ispit: ");
	scanf("%lf",&pi2t);
	if(pi2t<0 || pi2t>20){printf("Neispravan broj bodova");return 0;}
	printf("Prisustvo: ");
	scanf("%lf",&pt);
	...
	printf("I parcijalni ispit: ");
	scanf("%lf",&pi1b);
	if(pi1b<0 || pi1b>20){printf("Neispravan broj bodova");return 0;}
	printf("II parcijalni ispit: ");
	scanf("%lf",&pi2b);
	if(pi2b<0 || pi2b>20){printf("Neispravan broj bodova");return 0;}
	printf("Prisustvo: ");
	scanf("%lf",&pb);
	...
	printf("I parcijalni ispit: ");
	scanf("%lf",&pi1m);
	if(pi1m<0 || pi1m>20){printf("Neispravan broj bodova");return 0;}
	printf("II parcijalni ispit: ");
	scanf("%lf",&pi2m);
	if(pi2m<0 || pi2m>20){printf("Neispravan broj bodova");return 0;}
	printf("Prisustvo: ");
	scanf("%lf",&pm);
	...
	if(sm>=75 && sm<85){m=8;}
	if(sm>=85 && sm<92){m=9;}
	if(sm>=92 && sm<=100){m=10;}
	
	if(t==0 && m==0 && b==0){printf("Nijedan student nije polozio.\n");}
	...
	if(tbm==1)
	{
		...
		if(t!=m && t!=b && m!=b){printf("Svaki student ima razlicitu ocjenu.\n");}

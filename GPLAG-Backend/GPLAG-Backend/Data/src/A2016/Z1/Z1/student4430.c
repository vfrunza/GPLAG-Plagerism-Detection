...
int main() {
	...
	if(tarik_suma<55) brojac5++;
	if(bojan_suma<55) brojac5++;
	if(mirza_suma<55) brojac5++;
	
	if(tarik_suma>=55 && tarik_suma<65) brojac6++;
	if(bojan_suma>=55 && bojan_suma<65) brojac6++;
	if(mirza_suma>=55 && mirza_suma<65) brojac6++;
	
	if(tarik_suma>=65 && tarik_suma<75) brojac7++;
	if(bojan_suma>=65 && bojan_suma<75) brojac7++;
	if(mirza_suma>=65 && mirza_suma<75) brojac7++;
	
	if(tarik_suma>=75 && tarik_suma<85) brojac8++;
	if(bojan_suma>=75 && bojan_suma<85) brojac8++;
	if(mirza_suma>=75 && mirza_suma<85) brojac8++;
	
	if(tarik_suma>=85 && tarik_suma<95) brojac9++;
	if(bojan_suma>=85 && bojan_suma<95) brojac9++;
	if(mirza_suma>=85 && mirza_suma<95) brojac9++;
	
	if(tarik_suma>=95 && tarik_suma<=100) brojac10++;
	if(bojan_suma>=95 && bojan_suma<=100) brojac10++;
	if(mirza_suma>=95 && mirza_suma<=100) brojac10++;
	
	if(brojac5==3) printf("Nijedan student nije polozio.");
	else if(brojac5==2) printf("Jedan student je polozio.");
	else if(brojac5==1) printf("Dva studenta su polozila.");
	else if(brojac5==0) printf("Sva tri studenta su polozila.");

...
int main() {
	...
	if (T<55){TO=5; }
	else if (T>=55 && T<65){TO=6;}
	else if (T>=65 && T<75){TO=7;}
	else if (T>=75 && T<85){TO=8;}
	else if (T>=85 && T<92){TO=9;}
	else {TO=10;}
		
		if (B<55){BO=5;}
	else if (B>=55 && B<65){BO=6;}
	else if (B>=65 && B<75){BO=7;}
	else if (B>=75 && B<85){BO=8;}
	else if (B>=85 && B<92){BO=9;}
	else {BO=10;}
	
		if (M<55){MO=5;}
	else if (M>=55 && M<65){MO=6;}
	else if (M>=65 && M<75){MO=7;}
	else if (M>=75 && M<85){MO=8;}
	else if (M>=85 && M<92){MO=9;}
	else {MO=10;}
	
	if (TO!=5 && MO!=5 && BO!=5){
		printf("Sva tri studenta su polozila.\n");
		if(TO==MO && MO==BO){printf("Sva tri studenta imaju istu ocjenu.");}
		else if(TO!=MO && TO!=BO && BO!=MO){printf("Svaki student ima razlicitu ocjenu.");}
		else if(TO==MO && TO!=MO || BO==MO && BO!=TO ||BO==TO && MO!=BO){printf("Dva od tri studenta imaju istu ocjenu.");}
	}
	else if(TO==5 && MO==5 && BO==5){printf("Nijedan student nije polozio.\n");}
	else if(TO!=5 && (MO==5 && BO==5) || MO!=5 &&(TO==5 && BO==5)|| BO!=5 &&(TO==5 && MO==5)){printf("Jedan student je polozio.\n");}

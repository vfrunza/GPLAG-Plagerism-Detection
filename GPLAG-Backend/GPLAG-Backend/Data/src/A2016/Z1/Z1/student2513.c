...
int main () {
    ...
    if(tu<55 && bu<55 && mu<55) printf("Nijedan student nije polozio.");
    if(tu>=55 && bu>=55 && mu>=55) printf("Sva tri studenta su polozila.");
    if(tu>=55 && bu>=55 && mu<55) printf("Dva studenta su polozila."); 
    if(tu>=55 && mu>=55 && bu<55) printf("Dva studenta su polozila.");
    if(bu>=55 && mu>=55 && tu<55) printf("Dva studenta su polozila.");
    if((tu>=55 && mu<55 && bu<55) || (bu>=55 && tu<55 && mu<55) || (mu>=55 && tu<55 && bu<55))
    printf("Jedan student je polozio.");
    
    if(tu>=55 && tu<65) ocjena1=6;
    if(tu>=65 && tu<75) ocjena1=7;
    if(tu>=75 && tu<85) ocjena1=8;
    if(tu>=85 && tu<92) ocjena1=9;
    if(tu>=92 && tu<=100) ocjena1=10;
    
    if(bu>=55 && bu<65) ocjena2=6;
    if(bu>=65 && bu<75) ocjena2=7;
    if(bu>=75 && bu<85) ocjena2=8;
    if(bu>=85 && bu<92) ocjena2=9;
    if(bu>=92 && bu<=100) ocjena2=10;
    
    if(mu>=55 && mu<65) ocjena3=6;
    if(mu>=65 && mu<75) ocjena3=7;
    if(mu>=75 && mu<85) ocjena3=8;
    if(mu>=85 && mu<92) ocjena3=9;
    if(mu>=92 && mu<=100) ocjena3=10;

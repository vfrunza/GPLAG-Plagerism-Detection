...
int main() {
	...
	f=a+b+c+d+e;
	if(f>=55 && f<65) ocjena1=6;
	else if(f>=65 && f<75) ocjena1=7;
	else if(f>=75 && f<85) ocjena1=8;
	else if(f>=85 && f<92) ocjena1=9;
	else if(f>=92 && f<=100) ocjena1=10;
	
	f1=a1+b1+c1+d1+e1;
	if(f1>=55 && f1<65) ocjena2=6;
	else if(f1>=65 && f1<75) ocjena2=7;
	else if(f1>=75 && f1<85) ocjena2=8;
	else if(f1>=85 && f1<92) ocjena2=9;
	else if(f1>=92 && f1<=100) ocjena2=10;
	
	f2=a2+b2+c2+d2+e2;
	if(f2>=55 && f2<65) ocjena3=6;
	else if(f2>=65 && f2<75) ocjena3=7;
	else if(f2>=75 && f2<85) ocjena3=8;
	else if(f2>=85 && f2<92) ocjena3=9;
	else if(f2>=92 && f2<=100) ocjena3=10;

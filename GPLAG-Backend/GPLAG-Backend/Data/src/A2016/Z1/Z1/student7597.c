...
int main() {
	...
	if(UKUPNO<55 && UKUPNO1<55 && UKUPNO2<55){
		...
		if(UKUPNO<65) tarik_ocjena=6;
		else if(UKUPNO<75) tarik_ocjena=7;
		else if(UKUPNO<85) tarik_ocjena=8;
		else if(UKUPNO<92) tarik_ocjena=9;
		else tarik_ocjena=10;
		if(UKUPNO1<65) bojan_ocjena=6;
		else if(UKUPNO1<75) bojan_ocjena=7;
		else if(UKUPNO1<85) bojan_ocjena=8;
		else if(UKUPNO1<92) bojan_ocjena=9;
		else bojan_ocjena=10;
		if(UKUPNO2<65) mirza_ocjena=6;
		else if(UKUPNO2<75) mirza_ocjena=7;
		else if(UKUPNO2<85) mirza_ocjena=8;
		else if(UKUPNO2<92) mirza_ocjena=9;
		else mirza_ocjena=10;

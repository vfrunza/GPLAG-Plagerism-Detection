...
int main() {
	...
	scanf("%f", &prvi);
	if(prvi<0 || prvi>20){ printf("Neispravan broj bodova"); return 0;}
	printf("II parcijalni ispit: ");
	scanf("%f", &drugi);
	if(drugi<0 || drugi>20) {printf("Neispravan broj bodova"); return 0;}
	printf("Prisustvo: ");
	scanf("%f",&prisustvo);
	if(prisustvo<0 || prisustvo>10 ) {printf("Neispravan broj bodova"); return 0;}
	printf("Zadace: ");
	scanf("%f",&zadaca);
	if(zadaca<0 || zadaca>10) {printf("Neispravan broj bodova"); return 0;}
	printf("Zavrsni ispit: "); scanf("%f",&zavrsni);
	if(zavrsni<0 || zavrsni>40) {printf("Neispravan broj bodova"); return 0;}
	zbir1=prvi+drugi+zadaca+prisustvo+zavrsni+eps;
	if(zbir1<55) ocjena1=5;
	if(zbir1>=55 && zbir1<65) ocjena1=6;
	if(zbir1>=65 && zbir1<75) ocjena1=7;
	if(zbir1>=75 && zbir1<85) ocjena1=8;
	if(zbir1>=85 && zbir1<92) ocjena1=9;
	if(zbir1>=92 && zbir1<=100) ocjena1=10;
	...
	if(zbir3<55) ocjena2=5;
	if(zbir3>=55 && zbir3<65) ocjena3=6;
	if(zbir3>=65 && zbir3<75) ocjena3=7;
	if(zbir3>=75 && zbir3<85) ocjena3=8;
	if(zbir3>=85 && zbir3<92) ocjena3=9;
	if(zbir3>=92 && zbir3<=100) ocjena3=10; 
	if(zbir3<55 && zbir2<55 && zbir1<55) printf("Nijedan student nije polozio.");

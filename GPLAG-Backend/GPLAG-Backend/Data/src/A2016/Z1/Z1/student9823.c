...
int main() {
	...
	scanf("%lf", &pp1); if(pp1<0 || pp1>20) { printf("Neispravan broj bodova"); return 0; }
	printf("II parcijalni ispit: ");
	scanf("%lf", &dp1); if(dp1<0 || dp1>20) { printf("Neispravan broj bodova"); return 0; }
	printf("Prisustvo: ");
	scanf("%lf", &pris1); if(pris1<0 || pris1>10) { printf("Neispravan broj bodova"); return 0; }
	printf("Zadace: "); 
	scanf("%lf", &zadace1); if(zadace1<0 || zadace1>10) { printf("Neispravan broj bodova"); return 0; }
	printf("Zavrsni ispit: "); 
	scanf("%lf", &zISPIT1); if(zISPIT1<0 || zISPIT1>40) { printf("Neispravan broj bodova"); return 0; }
	
	printf("Unesite bodove za Bojana:\n");
	printf("I parcijalni ispit: "); 
	scanf("%lf", &pp2); if(pp2<0 || pp2>20) { printf("Neispravan broj bodova"); return 0; }
	printf("II parcijalni ispit: ");
	scanf("%lf", &dp2); if(dp2<0 || dp2>20) { printf("Neispravan broj bodova"); return 0; }
	printf("Prisustvo: "); 
	scanf("%lf", &pris2); if(pris2<0 || pris2>10) { printf("Neispravan broj bodova"); return 0; }
	printf("Zadace: "); 
	scanf("%lf", &zadace2); if(zadace2<0 || zadace2>10) { printf("Neispravan broj bodova"); return 0; }
	printf("Zavrsni ispit: ");
	scanf("%lf", &zISPIT2); if(zISPIT2<0 || zISPIT2>40) { printf("Neispravan broj bodova"); return 0; }
	
	printf("Unesite bodove za Mirzu:\n");
	printf("I parcijalni ispit: ");
	scanf("%lf", &pp3); if(pp3<0 || pp3>20) { printf("Neispravan broj bodova"); return 0; }
	printf("II parcijalni ispit: "); 
	scanf("%lf", &dp3); if(dp3<0 || dp3>20) { printf("Neispravan broj bodova"); return 0; }
	printf("Prisustvo: "); 
	scanf("%lf", &pris3); if(pris3<0 || pris3>10) { printf("Neispravan broj bodova"); return 0; }
	printf("Zadace: "); 
	scanf("%lf", &zadace3); if(zadace3<0 || zadace3>10) { printf("Neispravan broj bodova"); return 0; }
	printf("Zavrsni ispit: "); 
	scanf("%lf", &zISPIT3); if(zISPIT3<0 || zISPIT3>40) { printf("Neispravan broj bodova"); return 0; }
	...
	if(pris1<0 || pris1>10 || pris2<0 || pris2>10 || pris3<0 || pris3>10) { printf("Neispravan broj bodova"); return 0; }
			...
			if(suma1>=55 && suma1<65) {brojac1++; poloz++; } 
			else if(suma1>=65 && suma1<75) { brojac2++; poloz++; }
			else if(suma1>=75 && suma1<85) { brojac3++; poloz++; }
			else if(suma1>=85 && suma1<92) { brojac4++; poloz++; }
			else if(suma1>=92 && suma1<=100) { brojac5++; poloz++; } 
			
			if(suma2>=55 && suma2<65) { brojac1++;  poloz++; }
			else if(suma2>=65 && suma2<75) { brojac2++;poloz++; }
			else if(suma2>=75 && suma2<85) { brojac3++; poloz++; }
			else if(suma2>=85 && suma2<92) { brojac4++; poloz++; }
			else if(suma2>=92 && suma2<=100) { brojac5++; poloz++; }
			
			if(suma3>=55 && suma3<65) { brojac1++; poloz++; } 
			else if(suma3>=65 && suma3<75) { brojac2++; poloz++; }
			else if(suma3>=75 && suma3<85) { brojac3++; poloz++; }
			else if(suma3>=85 && suma3<92) { brojac4++; poloz++; }
			else if(suma3>=92 && suma3<=100) { brojac5++; poloz++; } 
			
			
			if(poloz==1) printf("Jedan student je polozio.\n");
			else if(poloz==2) printf("Dva studenta su polozila.\n");
			else if(poloz==3) printf("Sva tri studenta su polozila.\n");
			else printf("Nijedan student nije polozio.\n");
			
			if(suma1>=55 && suma2>=55 && suma3>=55){
			
			if(brojac1==3 || brojac2==3 || brojac3==3 || brojac4==3 || brojac5==3 ) printf("Sva tri studenta imaju istu ocjenu.");
			else if(brojac1==2 || brojac2==2 || brojac3==2 || brojac4==2 || brojac5==2) printf("Dva od tri studenta imaju istu ocjenu.");

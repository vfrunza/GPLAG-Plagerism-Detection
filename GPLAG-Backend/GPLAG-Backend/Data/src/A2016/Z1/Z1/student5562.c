...
int main() {
	...
	scanf("%f", &bod); if (bod - 20 > EPS || bod < -EPS) {printf("Neispravan broj bodova"); return 0;}
	uk += bod;
	...
	printf("Prisustvo: "); 
	scanf("%f", &bod); if (bod - 10 > EPS || bod < -EPS) {printf("Neispravan broj bodova"); return 0;}
	uk += bod;
	...
	scanf("%f", &bod); if (bod - 40 > EPS || bod < -EPS) {printf("Neispravan broj bodova"); return 0;}
	uk += bod;

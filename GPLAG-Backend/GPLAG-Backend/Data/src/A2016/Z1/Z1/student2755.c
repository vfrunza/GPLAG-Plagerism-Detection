...
int main() {
	...
	if(bodoviT<55) paoT++;
	else if(bodoviT>=55 && bodoviT<65) ocjenaT1++;
	else if(bodoviT>=65 && bodoviT<75) ocjenaT2++;
	else if(bodoviT>=75 && bodoviT<85) ocjenaT3++;
	else if(bodoviT>=85 && bodoviT<92) ocjenaT4++;
	else if(bodoviT>=92 && bodoviT<=100) ocjenaT5++;
	
	if(bodoviB<55) paoB++;
	else if(bodoviB>=55 && bodoviB<65) ocjenaB1++;
	else if(bodoviB>=65 && bodoviB<75) ocjenaB2++;
	else if(bodoviB>=75 && bodoviB<85) ocjenaB3++;
	else if(bodoviB>=85 && bodoviB<92) ocjenaB4++;
	else if(bodoviB>=92 && bodoviB<=100) ocjenaB5++;
	
	if(bodoviM<55) paoM++;
	else if(bodoviM>=55 && bodoviM<65) ocjenaM1++;
	else if(bodoviM>=65 && bodoviM<75) ocjenaM2++;
	else if(bodoviM>=75 && bodoviM<85) ocjenaM3++;
	else if(bodoviM>=85 && bodoviM<92) ocjenaM4++;
	else if(bodoviM>=92 && bodoviM<=100) ocjenaM5++;
	
	if(paoT==1 && paoB==1 && paoM==1) printf("Nijedan student nije polozio.");
	else if((paoT==1 && paoB==1) || (paoB==1 && paoM==1) || (paoT==1 && paoM==1)) printf("Jedan student je polozio.");

...
int main() {
	...
	SM=PPaM+DPaM+PM+ZM+ZIM;
		...
		if(ST<=54.9999) T=5;
		else if(ST>=55 && ST<65) T=6;
		else if(ST>=65 && ST<75) T=7;
		else if(ST>=75 && ST<85) T=8;
		else if(ST>=85 && ST<92) T=9;
		else T=10;
		
		if(SB<=54.9999) B=5;
		else if(SB>=55 && SB<65) B=6;
		else if(SB>=65 && SB<75) B=7;
		else if(SB>=75 && SB<85) B=8;
		else if(SB>=85 && SB<92) B=9;
		else B=10;
		
		if(SM<=54.9999) M=5;
		else if(SM>=55 && SM<65) M=6;
		else if(SM>=65 && SM<75) M=7;
		else if(SM>=75 && SM<85) M=8;
		else if(SM>=85 && SM<92) M=9;
		else M=10;
		...
		return 0;}
		else if(T!=5 && B!=5 && M!=5) printf("Sva tri studenta su polozila.\n");
		...
		else if(T!=B && T!=M && M!=B) printf("Svaki student ima razlicitu ocjenu.");

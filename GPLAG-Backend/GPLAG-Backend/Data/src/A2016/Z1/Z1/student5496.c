...
int main() {
	...
	printf("Zavrsni ispit: ");	scanf("%lf", &M5);
    	...
    	X2=B1+B2+B3+B4+B5;
	    X3=M1+M2+M3+M4+M5;
	if(X1<55 && X2<55 && X3<55){ printf("Nijedan student nije polozio.");
	return 0;
	}
	if((X1-55>=0 && X2-55<0 && X3-55<0)||(X1-55<0 && X2-55>=0 && X3-55<0)||(X1-55<0 && X2-55<0 && X3-55>=0)){ printf("Jedan student je polozio.\n");
	return 0;
	} 
	if((X1-55>=0 && X2-55>=0 && X3-55<0)||(X1-55<0 && X2-55>=0 && X3-55>=0)||(X1-55>=0 && X2-55<0 && X3-55>=0)){ printf("Dva studenta su polozila.\n");
	return 0;
	} 

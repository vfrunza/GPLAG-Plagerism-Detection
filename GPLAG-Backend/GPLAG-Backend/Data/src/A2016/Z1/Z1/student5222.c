...
int main() {
	...
	suma /= 1000.;
	if(suma < 55) ocjenaTarik = 5;
	else if(suma < 65) ocjenaTarik = 6;
	else if(suma < 75) ocjenaTarik = 7;
	else if(suma < 85) ocjenaTarik = 8;
	else if(suma < 92) ocjenaTarik = 9;
	else if(suma <= 100) ocjenaTarik = 10;
	else printf("Ne valja suma\n");
	...
	suma /= 1000.;
	if(suma < 55) ocjenaBojan = 5;
	else if(suma < 65) ocjenaBojan = 6;
	else if(suma < 75) ocjenaBojan = 7;
	else if(suma < 85) ocjenaBojan = 8;
	else if(suma < 92) ocjenaBojan = 9;
	else if(suma <= 100) ocjenaBojan = 10;
	else printf("Ne valja suma\n");
	...
	suma /= 1000.;
	if(suma < 55) ocjenaMirza = 5;
	else if(suma < 65) ocjenaMirza = 6;
	else if(suma < 75) ocjenaMirza = 7;
	else if(suma < 85) ocjenaMirza = 8;
	else if(suma < 92) ocjenaMirza = 9;
	else if(suma <= 100) ocjenaMirza = 10;
	else printf("Ne valja suma\n");
	...
	else if(ocjenaTarik > 5 && (ocjenaBojan > 5 || ocjenaMirza > 5)) printf("Dva studenta su polozila");
	else if(ocjenaMirza > 5 && (ocjenaTarik > 5 || ocjenaBojan > 5)) printf("Dva studenta su polozila");
	else if(ocjenaBojan > 5 && (ocjenaTarik > 5 || ocjenaMirza > 5)) printf("Dva studenta su polozila");
	else if(ocjenaTarik > 5 || ocjenaBojan > 5 || ocjenaMirza > 5) printf("Jedan student je polozio");

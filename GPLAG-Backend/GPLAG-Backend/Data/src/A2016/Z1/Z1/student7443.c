...
int main() {
	float tprvipi=0, tdrugipi=0, tzadaca=0, tprisustvo=0, bprvipi=0, bdrugipi=0, bzadaca=0, bprisustvo=0, mprvipi=0, mdrugipi=0, mzadaca=0, mprisustvo=0, tarik=0, bojan=0, mirza=0, tzavrsni=0, bzavrsni=0, mzavrsni=0;
	/*Bodovi tarik*/

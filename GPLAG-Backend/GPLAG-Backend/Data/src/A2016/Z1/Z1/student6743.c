...
int main(){
    ...
    printf("\nI parcijalni ispit: ");
    scanf("%f",&bodovi1I);
    if(bodovi1I<0 || bodovi1I>20) {printf("Neispravan broj bodova"); return 0;}
    
    printf("II parcijalni ispit: ");
    scanf("%f",&bodovi1II);
    if(bodovi1II<0 || bodovi1II>20) {printf("Neispravan broj bodova"); return 0;}
	...
	printf("\nI parcijalni ispit: ");
	scanf("%f",&bodovi2I);
	if(bodovi2I<0 || bodovi2I>20) {printf("Neispravan broj bodova"); return 0;}
	
	printf("II parcijalni ispit: ");
	scanf("%f",&bodovi2II);
	if(bodovi2II<0 || bodovi2II>20) {printf("Neispravan broj bodova"); return 0;}
	...
	printf("\nI parcijalni ispit: ");
	scanf("%f",&bodovi3I);
	if(bodovi3I<0 || bodovi3I>20) {printf("Neispravan broj bodova"); return 0;} 
	
	printf("II parcijalni ispit: ");
	scanf("%f",&bodovi3II);
	if(bodovi3II<0 || bodovi3II>20) {printf("Neispravan broj bodova"); return 0;}
	...
	if(ukupno1<55) {Tarik=5;}
	if(ukupno2<55) {Bojan=5;}
	if(ukupno3<55) {Mirza=5;}
	
	if(ukupno1>=55 && ukupno1<65) Tarik=6;
	if(ukupno2>=55 && ukupno2<65) Bojan=6;
	if(ukupno3>=55 && ukupno3<65) Mirza=6;
	
	if(ukupno1>=65 && ukupno1<75) Tarik=7;
	if(ukupno2>=65 && ukupno2<75) Bojan=7;
	if(ukupno3>=65 && ukupno3<75) Mirza=7;
	
	if(ukupno1>=75 && ukupno1<85) Tarik=8; 
	if(ukupno2>=75 && ukupno2<85) Bojan=8;
	if(ukupno3>=75 && ukupno3<85) Mirza=8;
	
	if(ukupno1>=85 && ukupno1<92) Tarik=9;
	if(ukupno2>=85 && ukupno2<92) Bojan=9;
	if(ukupno3>=85 && ukupno3<92) Mirza=9;
	
	if(ukupno1>=92 && ukupno1<=100) Tarik=10;
	if(ukupno2>=92 && ukupno2<=100) Bojan=10;
	if(ukupno3>=92 && ukupno3<=100) Mirza=10;

...
int main() {
	...
	if (tuk<55) { o1=5; }
	else if (tuk>=55 && tuk<65) { o1=6; }
	else if (tuk>=65 && tuk<75) { o1=7; }
	else if (tuk>=75 && tuk<85) { o1=8; }
	else if (tuk>=85 && tuk<92) { o1=9; }
	else { o1=10; }
	
	if (buk<55) { o2=5; }
	else if (buk>=55 && buk<65) { o2=6; }
	else if (buk>=65 && buk<75) { o2=7; }
	else if (buk>=75 && buk<85) { o2=8; }
	else if (buk>=85 && buk<92) { o2=9; }
	else { o2=10; }
	
	if (muk<55) { o3=5; }
	else if (muk>=55 && muk<65) { o3=6; }
	else if (muk>=65 && muk<75) { o3=7; }
	else if (muk>=75 && muk<85) { o3=8; }
	else if (muk>=85 && muk<92) { o3=9; }
	else { o3=10; }
	...
	if (o1>5 && o2>5 && o3>5) {
		...
		if(o2==5 && o3==5) { printf("Jedan student je polozio."); }
		else { printf("Dva studenta su polozila."); }
		return 0;
	}
	else if (o2==6) {
		if(o1==5 && o3==5) { printf("Jedan student je polozio."); }
		else { printf("Dva studenta su polozila."); } 
		return 0;
	}
	else {
		if(o2==5 && o1==5) { printf("Jedan student je polozio."); }
		else { printf("Dva studenta su polozila.");}
		return 0;
	}

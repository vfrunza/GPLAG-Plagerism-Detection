...
printf("Zadace: ");
scanf("%f",&zadacat);
if(zadacat<0 || zadacat>10) {printf("Neispravan broj bodova"); return 0;}
...
printf("Zadace: ");
scanf("%f",&zadacab);
if(zadacab>10 || zadacab<0) {printf("Neispravan broj bodova"); return 0;}
printf("Zavrsni ispit: ");
scanf("%f",&zavrsb);
...
printf("Zadace: ");
scanf("%f",&zadacam);
if(zadacam<0 || zadacam>10) {printf("Neispravan broj bodova"); return 0;}
printf("Zavrsni ispit: ");
scanf("%f",&zavrsm);
...
if(ocjena_mirza>5 && ocjena_bojan>5 && ocjena_tarik>5){
    printf("Sva tri studenta su polozila.\n");
     ...
     else {printf("Sva tri studenta imaju istu ocjenu."); return 0;}
}

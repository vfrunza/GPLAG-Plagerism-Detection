...
int main() {
   ...
   if (tarikb>=55 && tarikb<=65){ tariko=6;}
  else if (tarikb>=65 && tarikb<=75){ tariko=7;}
  else if (tarikb>=75 && tarikb<=85){ tariko=8;}
  else if (tarikb>=85 && tarikb<=92){ tariko=9;}
  else if (tarikb>=92 && tarikb<=100){ tariko=10;}
  if (bojanb>=55 && bojanb<=65){ bojano=6;}
  else if (bojanb>=65 && bojanb<=75){ bojano=7;}
  else if (bojanb>=75 && bojanb<=85){ bojano=8;}
  else if (bojanb>=85 && bojanb<=92){ bojano=9;}
  else if (bojanb>=92 && bojanb<=100){ bojano=10;}
  if (mirzab>=55 && mirzab<=65){ mirzao=6;}
  else if (mirzab>=65 && mirzab<=75){ mirzao=7;}
  else if (mirzab>=75 && mirzab<=85){ mirzao=8;}
  else if (mirzab>=85 && mirzab<=92){ mirzao=9;}
  else if (mirzab>=92 && mirzab<=100){ mirzao=10;}

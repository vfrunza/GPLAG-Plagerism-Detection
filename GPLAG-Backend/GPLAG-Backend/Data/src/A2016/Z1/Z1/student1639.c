...
int main() {
	...
	scanf("%lf",&tpp);
	if(tpp<0 || tpp>20){printf("Neispravan broj bodova"); return 0;}
	else{
	printf("II parcijalni ispit: ");
	scanf("%lf", &tdp);
	if(tdp<0 || tpp>20){printf("Neispravan broj bodova"); return 0;}
	else{
	printf("Prisustvo: ");
	scanf("%lf", &tp);
	...
	printf ("I parcijalni ispit: ");
	scanf("%lf",&bpp);
	if(bpp<0 || bpp>20){printf("Neispravan broj bodova"); return 0;}
	else{
	printf("II parcijalni ispit: ");
	scanf("%lf", &bdp);
	if(bdp<0 || bdp>20){printf("Neispravan broj bodova"); return 0;}
	else{
	printf("Prisustvo: ");
	scanf("%lf", &bp);
	...
	printf ("I parcijalni ispit: ");
	scanf("%lf",&mpp);
	if(mpp<0 || mpp>20){printf("Neispravan broj bodova"); return 0;}
	else{
	printf("II parcijalni ispit: ");
	scanf("%lf", &mdp);
	if(mdp<0 || mdp>20){printf("Neispravan broj bodova"); return 0;}
	else{
	printf("Prisustvo: ");
	scanf("%lf", &mp);
	...
	if(mzi<0 || mzi>40){printf("Neispravan broj bodova"); return 0;}
   	...
   	if((st<55 && sb<55 && sm>=55)||(st<55 && sb>=55 && sm<55)||(st>=55 && sb<55 && sm<55)){printf("Jedan student je polozio."); return 0;}
    else if((st<55 && sb>=55 && sm>=55)||(st>=55 && sb>=55 && sm<55)||(st>=55 &&sb<55 && sm>=55)){printf("Dva studenta su polozila."); return 0;}
    else if(st<55 && sb<55 && sm<55){printf("Nijedan student nije polozio."); return 0;}
    else if(st>55 && sb>55 && sm>55){printf("Sva tri studenta su polozila.\n");
    {if(ot==ob && ob==om){printf("Sva tri studenta imaju istu ocjenu.");}
    else if((ot==ob && ob!=om)|| (ot==om && om!=ob)|| (ob==om && om!=ot)){printf("Dva od tri studenta imaju istu ocjenu.");}

...
if (ocenat==ocenab) { printf ("Dva od tri studenta imaju istu ocjenu.");
}
if (ocenat==ocenam) { printf ("Dva od tri studenta imaju istu ocjenu.");
}
if (ocenab==ocenam) { printf ("Dva od tri studenta imaju istu ocjenu.");
}

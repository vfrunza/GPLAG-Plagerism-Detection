...
int main() {
	...
	if(T < 54.95 && B < 55 && M < 55) printf("Nijedan student nije polozio.");
	if((T >= 54.95 && B < 55 && M < 55) || (T < 55 && B >= 55 && M < 55) || (T < 55 && B < 55 && M >= 55)) printf("Jedan student je polozio.");
	if((T >= 55 && B >= 55 && M < 55) || (T < 55 && B >= 55 && M >= 55) || (T >= 55 && B < 55 && M >= 55)) printf("Dva studenta su polozila.");
	if(T >= 55 && B >= 55 && M >= 55) printf("Sva tri studenta su polozila.");
	
	if(T<55) ocjenaT = 5;
	if(T>=55 && T < 65) ocjenaT = 6;
	if(T>=65 && T < 75) ocjenaT = 7;
	if(T>=75 && T < 85) ocjenaT = 8;
	if(T>=85 && T < 92) ocjenaT = 9;
	if(T>=92 && T <=100) ocjenaT = 10;
	
	if(B<55) ocjenaB = 5;
	if(B>=55 && B < 65) ocjenaB = 6;
	if(B>=65 && B < 75) ocjenaB = 7;
	if(B>=75 && B < 85) ocjenaB = 8;
	if(B>=85 && B < 92) ocjenaB = 9;
	if(B>=92 && B <=100) ocjenaB = 10;
	
	if(M<55) ocjenaM = 5;
	if(M>=55 && M < 65) ocjenaM = 6;
	if(M>=65 && M < 75) ocjenaM = 7;
	if(M>=75 && M < 85) ocjenaM = 8;
	if(M>=85 && M < 92) ocjenaM = 9;
	if(M>=92 && M <=100) ocjenaM = 10;
	
	if(ocjenaT > 5 && ocjenaB > 5 && ocjenaM > 5) {
	if(ocjenaT == ocjenaB && ocjenaB == ocjenaM) printf("\nSva tri studenta imaju istu ocjenu.");
	if((ocjenaT != ocjenaB) && (ocjenaB != ocjenaM) && (ocjenaT != ocjenaM)) printf("\nSvaki student ima razlicitu ocjenu.");
	if(((ocjenaT == ocjenaB) && (ocjenaB!=ocjenaM)) || ((ocjenaB == ocjenaM) && (ocjenaM!=ocjenaT)) || ((ocjenaT == ocjenaM) && (ocjenaM != ocjenaB))) printf("\nDva od tri studenta imaju istu ocjenu.");
	}
	return 0;
}

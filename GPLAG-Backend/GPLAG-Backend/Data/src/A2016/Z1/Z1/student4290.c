...
int ocjene(float a){
	if(a<55)return 5;
	else if(a>54 && a<65)return 6;
	else if(a>64 && a<75)return 7;
	else if(a>74 && a<85)return 8;
	else if(a>84 && a<95)return 9;
...
int main() {
	...
	printf("Unesite bodove za Bojana: \n");
		...
		if((mo==5)&&(to==5)&&(bo==5))
			...
			if((to==mo)&& to==bo)printf("Sva tri studenta imaju istu ocjenu.\n");
			else if((to==bo && to!=mo)||(to==mo && to!=bo)||(bo==mo && bo!=to))
				printf("Dva od tri studenta imaju istu ocjenu.");
			else if(bo!=mo!=to)printf("Svaki student ima razlicitu ocjenu.");
		}

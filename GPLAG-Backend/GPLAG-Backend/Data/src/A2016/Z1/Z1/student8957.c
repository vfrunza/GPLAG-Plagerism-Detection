...
int main() {
	...
	scanf ("%lf",&IpT); if (IpT<0 || IpT>20) {printf ("Neispravan broj bodova"); return 0;}
	printf ("II parcijalni ispit: ");
	scanf("%lf",&IIpT); if (IIpT<0 || IIpT>20) { printf ("Neispravan broj bodova"); return 0;}
	printf ("Prisustvo: ");
	...
	printf ("I parcijalni ispit: ");
	scanf ("%lf",&IpB); if (IpB<0 || IpB>20) { printf ("Neispravan broj bodova"); return 0;}
	printf ("II parcijalni ispit: ");
	scanf("%lf",&IIpB);if (IIpB<0 || IIpB>20) { printf ("Neispravan broj bodova"); return 0;}
	printf ("Prisustvo: ");
	...
	printf ("I parcijalni ispit: ");
	scanf ("%lf",&IpM);if (IpM<0 || IpM>20) { printf ("Neispravan broj bodova"); return 0;}
	printf ("II parcijalni ispit: ");
	scanf("%lf",&IIpM);if (IIpM<0 || IIpM>20) { printf ("Neispravan broj bodova"); return 0;}
	printf ("Prisustvo: ");
	scanf ("%lf",&pM);if (pM<0 || pM>10) { printf ("Neispravan broj bodova"); return 0;}
	printf("Zadace: ");
	scanf ("%lf",&zM);if (zM<0 || zM>20) { printf ("Neispravan broj bodova"); return 0;}
	printf ("Zavrsni ispit: ");

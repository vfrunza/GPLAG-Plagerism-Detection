...
int main() {
	...
	if(k==0){
		printf ("Najpopularnija boja je crna (0.00%%).");
			...
			printf("Najpopularnija boja je bijela (%.2f%%).",d);
		}else if(s>=c && s>=b && s>=v && s>=p){
			printf("Najpopularnija boja je siva (%.2f%%).",e);
		}else if(v>=c && v>=b && v>=s && v>=p){
			printf("Najpopularnija boja je crvena (%.2f%%).",h);
		}else if(p>=c && p>=b && p>=s && p>=v){
			printf("Najpopularnija boja je plava (%.2f%%).",g);}

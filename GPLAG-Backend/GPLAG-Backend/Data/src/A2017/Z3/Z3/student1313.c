#include <stdio.h> Napisati funkciju izbaci_cifre koja prima dva niza tipa int. 
Prvi niz sadrži određeni broj cijelih brojeva, a drugi niz je niz cifara. 
Potrebno je iz svih članova prvog niza izbaciti sve one cifre koje se nalaze u drugom nizu. 
Ako nakon izbacivanja cifara u nekom članu niza ne preostane niti jedna cifra, 
taj član niza treba dobiti vrijednost nula.

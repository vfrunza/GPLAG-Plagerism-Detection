											     ...
											     int* niz3, int velicina3)
{
	...
	for(; i < velicina1; ++i)
	{
		//int dupli = provjera_broja(niz1, velicina1, niz1[i]);
...
int dva_od_tri(int* niz1, int velicina1, int* niz2, int velicina2, 
													int* niz3, int velicina3)
{
	/* pozivamo pregled izmedju prvog i drugog niza onda prvog i treceg pa drugog i treceg 
	   i sabereno pojavljivanja */ 

zadatak sa zadace 4 i zadatak sa mog i sarinog ispita od sarah: šalju se  2 stringa i broj, ako rijec ima više slova
 od tog broja samo da se jedno slovo ostavi u stringu
#include <stdio.h>

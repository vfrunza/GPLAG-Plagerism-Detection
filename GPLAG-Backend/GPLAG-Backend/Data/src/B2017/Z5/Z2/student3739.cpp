...
class Laptop{
    ...
    std::shared_ptr<Student> &DajKodKogaJe() {
...
class Administracija {
    ...
    void RegistrirajNovogStudenta(int index, std::string god_studija, std::string ime_prezime, std::string adresa, std::string br_tel) {
        ...
        std::shared_ptr<Student>novi_student=std::make_shared<Student>( index,god_studija, ime_prezime, adresa, br_tel);
    ...
    void RegistrirajNoviLaptop(int ev_broj, std::string naziv, std::string karakteristike) {
       ...
       std::shared_ptr<Laptop>novi_laptop=std::make_shared<Laptop>(ev_broj,naziv,karakteristike);
    ...
    Student &NadjiStudenta(int index) {
        ...
        return *mapa_studenata[index].get();
    }
    Laptop &NadjiLaptop(int ev_broj) {
        ...
        return *mapa_laptopa[ev_broj].get();
    }

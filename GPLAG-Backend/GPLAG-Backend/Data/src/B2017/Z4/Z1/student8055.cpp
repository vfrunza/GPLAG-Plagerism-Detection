...
bool DaLiSeDodirujuIznutra(const Kugla & k1, const Kugla & k2) {
    return  JesuLiJednaki( RastojanjeCentara(k1.x, k1.y, k1.z, k2.x, k2.y, k2.z) , std::fabs(k1.r - k2.r) );
}
bool DaLiSePreklapaju(const Kugla & k1, const Kugla & k2) {
    return  RastojanjeCentara(k1.x, k1.y, k1.z, k2.x, k2.y, k2.z) <  (k1.r +k2.r) ;
}
bool DaLiSeSijeku (const Kugla & k1, const Kugla & k2) {
    return RastojanjeCentara(k1.x, k1.y, k1.z, k2.x, k2.y, k2.z) > std::fabs(k1.r - k2.r) &&
           RastojanjeCentara(k1.x, k1.y, k1.z, k2.x, k2.y, k2.z) < k1.r + k2.r; 
}
...
int main ()
{
    ...
    if(std::cin)  {if (n<=0 )   {std::cout<< "Neispravan broj kugli, unesite ponovo!\n"; continue; } else {break;}    }

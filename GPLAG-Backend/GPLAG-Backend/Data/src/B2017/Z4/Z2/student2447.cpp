...
bool DaLiSuIdenticne(const Kugla &k1, const Kugla &k2){
     if(Kugla::Jednaki(k1.DajX),k2.DajX()) && Kugla::Jednaki(k1.DajY),k2.DajY()) && Kugla::Jednaki(k1.DajZ),k2.DajZ()) && Kugla::Jednaki(k1.DajPoluprecnik()),k2.DajPoluprecnik())) return true;
     return false;
}
...
bool DaLiSePreklapaju(const Kugla &k1, const Kugla &k2){
     if(DaLiSeDodirujuIznutra(k1, k2) || DaLiSeSijeku(k1, k2) || DaLiSuIdenticne(k1, k2) || DaLiSuKoncentricne(k1, k2) || k1.DaLiSadrzi(k2) || k2.DaLiSadrzi(k1)) return true;
     return false;
}
bool DaLiSeSijeku(const Kugla &k1, const Kugla &k2){
     if(RastojanjeCentara(k1, k2) < k1.DajPoluprecnik() + k2.DajPoluprecnik() && DaLiSeDodirujuIznutra(k1, k2) == false && k1.DaLiSadrzi(k2) == false && k2.DaLiSadrzi(k1) == false && DaLiSuIdenticne(k1, k2) == false && DaLiSuKoncentricne(k1, k2) == false)
     return true;
     return false;
}

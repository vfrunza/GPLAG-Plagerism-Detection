...
public:
    explicit Pregledi(int max_broj_pregleda){
        lista= new Pregled  *[max_broj_pregleda];
        kap=max_broj_pregleda;
        st=0;
    }
    Pregledi(std::initializer_list<Pregled> spisak_pregleda){
        lista=new Pregled *[spisak_pregleda.size()];
        st=spisak_pregleda.size();
        int br=0;
        for(auto it=spisak_pregleda.begin(); it!=spisak_pregleda.end(); it++){
            lista[br]=new Pregled(*it);
            br++;
        }
    }
    ~Pregledi(){
    ...
    Pregledi &operator =(const Pregledi &pregledi){
        if(this==&pregledi) return *this;
          ...
          kap = pregledi.kap;
          st = pregledi.st;
          lista = new Pregled*[kap];
          for(int i=0; i<st; i++)
          lista[i] = new Pregled(*pregledi.lista[i]);
          return *this;
    ...
    Pregledi(const Pregledi &pregledi){
        ...
        st=pregledi.st;
        lista=new Pregled *[kap];
        for(int i=0; i<st; i++) lista[i]=new Pregled(*pregledi.lista[i]);
    }
    void RegistrirajPregled(const std::string &ime_pacijenta,
     const Datum &datum_pregleda, const Vrijeme &vrijeme_pregleda){
         if(st==kap) throw range_error("Dostignut maksimalni broj pregleda");
          lista[st++]=new Pregled(ime_pacijenta,datum_pregleda,vrijeme_pregleda);
    ...
    Pregledi(Pregledi &&pregledi){
        ...
        st=pregledi.st;
        lista=new Pregled*[kap];
        for(int i=0; i<st; i++) lista[i]=pregledi.lista[i];
        for(int i=0; i<pregledi.kap; i++) pregledi.lista[i]=nullptr;
    ...
    void RegistrirajPregled(const std::string &ime_pacijenta, int dan_pregleda,
     ...
     int minute_pregleda){
         if(st==kap) throw range_error("Dostignut maksimalni broj pregleda");
          lista[st++] = new Pregled(ime_pacijenta,dan_pregleda,mjesec_pregleda, godina_pregleda, sati_pregleda, minute_pregleda);
    ...
    int DajBrojPregledaNaDatum(const Datum &datum) const{
        try{
          return count_if(lista, lista+st, [datum](Pregled *p){
    ...
    Pregled &DajNajranijiPregled(){
        if (st==0) throw domain_error("Nema registriranih pregleda");
          return *(*(min_element(lista, lista+st, [](Pregled *p1, Pregled *p2){return(DolaziPrije(*p1,*p2));})));

    }
    int DajBrojPregleda() const { return st;}
    ...
    void ObrisiNajranijiPregled(){
        ...
        for(int i=0; i<st; i++){
            ...
            {
                delete lista[i];
                for(int j=i; j<st-1; j++) lista[j]=lista[j+1];
                st--;
                break;
            }
    ...
    void IsprazniKolekciju(){
        if(st==0) throw domain_error("Nema registriranih pregleda");
          for(int i=0; i<st; i++) delete lista[i];
          st=0; kap=0;
    ...
    void IspisiPregledeNaDatum(const Datum &datum) const{
        Pregled **drugi=new Pregled*[DajBrojPregledaNaDatum(datum)];
          int j=0;
          auto t1=datum.Ocitaj();
          for(int i=0; i<st; i++)
          {
    ...
    void IspisiSvePreglede() const{
          Pregled **drugi = new Pregled*[st];
          for(int i=0; i<st; i++) drugi[i]=lista[i];
          for(int i=0; i<st; i++)
               for(int j=i; j<st; j++)
               {
                    if(!DolaziPrije(*drugi[i],*drugi[j]))

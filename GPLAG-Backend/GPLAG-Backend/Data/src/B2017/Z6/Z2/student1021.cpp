...
class Spremnik {
    ...
    public:
        ...
        string DajNaziv() const { return naziv_predmeta; }
};

class PolimorfniSpremnik {
    Spremnik *pok;
    void Testiraj() const { if (pok==nullptr) throw std::logic_error("Nespecificiran spremnik"); }
    public:
        PolimorfniSpremnik() {
        ...
        PolimorfniSpremnik(const PolimorfniSpremnik &skladiste) {
            if (skladiste.pok==nullptr) {
                pok=nullptr;
            }
            if (skladiste.pok!=nullptr) {
                pok=skladiste.pok->DajKopiju();
            }
            else {
                pok=skladiste.pok->DajKopiju();
            }
        ...
        PolimorfniSpremnik(const Spremnik &skladiste) {
            pok=skladiste.DajKopiju();
        }
        
        PolimorfniSpremnik &operator =(const PolimorfniSpremnik &skladiste) {
            Spremnik *pok1(nullptr); if (skladiste.pok!=nullptr) pok1=skladiste.pok->DajKopiju();
            delete pok; pok=pok1;
            return *this;
        }
        
        PolimorfniSpremnik(PolimorfniSpremnik &&skladiste) {
            pok=skladiste.pok;
            skladiste.pok=nullptr;
        }

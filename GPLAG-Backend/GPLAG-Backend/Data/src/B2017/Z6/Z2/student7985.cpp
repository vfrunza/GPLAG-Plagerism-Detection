...
class PolimorfniSpremnik{
    Spremnik* p_spremnik;
    void Test() const {
        if(!p_spremnik) throw logic_error("Nespecificiran spremnik");
    }
  public:
    ...
    */ // ** ili samo prosto copy&swap:
    PolimorfniSpremnik& operator =(PolimorfniSpremnik spremnik){
        swap(spremnik.p_spremnik, p_spremnik);
        return *this;
    }
    // **ne treba pomjerajući operator dodjele ?**

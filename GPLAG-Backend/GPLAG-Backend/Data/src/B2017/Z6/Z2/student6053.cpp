...
class PolimorfniSpremnik{
    shared_ptr<Spremnik> p;
    void Provjera()const{
        if(p == nullptr)
        throw logic_error("Nespecificiran spremnik");}
    public:
    double DajTezinu()const{Provjera();return p->DajTezinu();}
    double DajUkupnuTezinu()const{Provjera();return p->DajUkupnuTezinu();}
    void Ispisi()const{Provjera();p->Ispisi();}
    PolimorfniSpremnik():p(nullptr){}
    shared_ptr<Spremnik> DajKopiju()const{Provjera();return p->DajKopiju();}
    PolimorfniSpremnik(const PolimorfniSpremnik &a):p(a.DajKopiju()){}
    PolimorfniSpremnik &operator =(const PolimorfniSpremnik &a){p=a.DajKopiju();return *this;}
    PolimorfniSpremnik &operator =(PolimorfniSpremnik &&a){p=a.p;return *this;}
    PolimorfniSpremnik(PolimorfniSpremnik &&a):p(a.p){}
    PolimorfniSpremnik(const Spremnik &a):p(a.DajKopiju()){}
    PolimorfniSpremnik(Spremnik &&a){p=a.DajKopiju();}
    PolimorfniSpremnik &operator =(const Spremnik &a){p=a.DajKopiju();return *this;}
    PolimorfniSpremnik &operator =(Spremnik &&a){p=a.DajKopiju();return *this;}
    ~PolimorfniSpremnik(){}
};
class Skladiste{

...
// Zadatak 2.           // NAPOMENA : U ZADATKU NIJE RECENO DA JE KORISTENJE FUNKCIJA IZ stdlib.h i string.h ZABRANJENO,
//            ZADATAK JE URADNJEN 20.12.2016, ZBOG MOGUCIH NAKNADNIH IZMJENA NAPOMENA :D //
// Funkcija kodiraj koja kodira neki tekst
// Funkcija prima neki tekst i prazan string od min 96 elemenata u koju smjestamo ASCI-tabelu

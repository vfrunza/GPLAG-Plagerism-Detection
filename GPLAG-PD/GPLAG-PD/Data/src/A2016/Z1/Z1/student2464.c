...
int main()
{
   ...
   else if (Tarikbod >= 55 && Tarikbod < 65)
   {
      Tarikocjena = 6;
   }
   else if (Tarikbod >= 65 && Tarikbod < 75)
   {
      Tarikocjena = 7;
   }
   else if (Tarikbod >= 75 && Tarikbod < 85)
   {
      Tarikocjena = 8;
   }
   else if (Tarikbod >= 85 && Tarikbod < 92)
   {
      Tarikocjena = 9;
   }
   else
   ...
   else if (Bojanbod >= 55 && Bojanbod < 65)
   {
      Bojanocjena = 6;
   }
   else if (Bojanbod >= 65 && Bojanbod < 75)
   {
      Bojanocjena = 7;
   }
   else if (Bojanbod >= 75 && Bojanbod < 85)
   {
      Bojanocjena = 8;
   }
   else if (Bojanbod >= 85 && Bojanbod < 92)
   {
      Bojanocjena = 9;
   }
   else
   ...
   else if (Mirzabod >= 55 && Mirzabod < 65)
   {
      Mirzaocjena = 6;
   }
   else if (Mirzabod >= 65 && Mirzabod < 75)
   {
      Mirzaocjena = 7;
   }
   else if (Mirzabod >= 75 && Mirzabod < 85)
   {
      Mirzaocjena = 8;
   }
   else if (Mirzabod >= 85 && Mirzabod < 92)
   {
      Mirzaocjena = 9;
   }
   else
   ...
   if (brpolozio == 3)
   {
      ...
      if (Mirzaocjena == Tarikocjena && Tarikocjena == Bojanocjena)
      {
         printf("Sva tri studenta imaju istu ocjenu.");
      }
      else if (Tarikocjena != Bojanocjena && Mirzaocjena != Tarikocjena && Bojanocjena != Mirzaocjena)
      {

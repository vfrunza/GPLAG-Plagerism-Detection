...
int main()
{
   ...
   {
      if (Tsuma >= 55 - eps && Tsuma < 65)
      {
         Tocjena = 6;
      }
      if (Tsuma >= 65 && Tsuma < 75)
      {
         Tocjena = 7;
      }
      if (Tsuma >= 75 && Tsuma < 85)
      {
         Tocjena = 8;
      }
      if (Tsuma >= 85 && Tsuma < 92)
      {
         Tocjena = 9;
      }
      if (Tsuma >= 92 && Tsuma <= 100)
      {
         Tocjena = 10;
      }
      brpolozenih++;
   ...
   {
      if (Bsuma >= 55 - eps && Bsuma < 65)
      {
         Bocjena = 6;
      }
      if (Bsuma >= 65 && Bsuma < 75)
      {
         Bocjena = 7;
      }
      if (Bsuma >= 75 && Bsuma < 85)
      {
         Bocjena = 8;
      }
      if (Bsuma >= 85 && Bsuma < 92)
      {
         Bocjena = 9;
      }
      if (Bsuma >= 92 && Bsuma <= 100)
      {
         Bocjena = 10;
      }
      brpolozenih++;
   ...
   {
      if (Msuma >= 55 - eps && Msuma < 65)
      {
         Mocjena = 6;
      }
      if (Msuma >= 65 && Msuma < 75)
      {
         Mocjena = 7;
      }
      if (Msuma >= 75 && Msuma < 85)
      {
         Mocjena = 8;
      }
      if (Msuma >= 85 && Msuma < 92)
      {
         Mocjena = 9;
      }
      if (Msuma >= 92 && Msuma <= 100)
      {
         Mocjena = 10;
      }
      brpolozenih++;

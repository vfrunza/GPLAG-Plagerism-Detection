...
int main()
{
   ...
   else if (zbir1 + A >= 55 && zbir1 < 65)
   {
      ocjena_tarik = 6;
   }
   else if (zbir1 + A >= 65 && zbir1 < 75)
   {
      ocjena_tarik = 7;
   }
   else if (zbir1 + A >= 75 && zbir1 < 85)
   {
      ocjena_tarik = 8;
   }
   else if (zbir1 + A >= 85 && zbir1 < 92)
   {
      ocjena_tarik = 9;
   }
   else
   ...
   else if (zbir2 + A >= 55 && zbir2 < 65)
   {
      ocjena_bojan = 6;
   }
   else if (zbir2 + A >= 65 && zbir2 < 75)
   {
      ocjena_bojan = 7;
   }
   else if (zbir2 + A >= 75 && zbir2 < 85)
   {
      ocjena_bojan = 8;
   }
   else if (zbir2 + A >= 85 && zbir2 < 95)
   {
      ocjena_bojan = 9;
   }
   else
   ...
   else if (zbir3 + A >= 55 && zbir3 < 65)
   {
      ocjena_mahir = 6;
   }
   else if (zbir3 + A >= 65 && zbir3 < 75)
   {
      ocjena_mahir = 7;
   }
   else if (zbir3 + A >= 75 && zbir3 < 85)
   {
      ocjena_mahir = 8;
   }
   else if (zbir3 + A >= 85 && zbir3 < 95)
   {
      ocjena_mahir = 9;
   }
   else

...
int main()
{
   ...
   if (b1t >= 0 && b1t <= 20 && b1b >= 0 && b1b <= 20 && b1m >= 0 && b1m <= 20 && b2t >= 0 && b2t <= 20 && b2b >= 0 && b2b <= 20 && b2m >= 0 && b2m <= 20 && pt >= 0 && pt <= 10 && pb >= 0 && pb <= 10 && pm >= 0 && pm <= 10 && zt >= 0 && zt <= 10 && zb >= 0 && zb <= 10 && zm >= 0 && zm <= 10 && zit >= 0 && zit <= 40 && zib >= 0 && zib <= 40 && zim >= 0 && zim <= 40)
   {
      ...
      else if (ob > 5 && ot > 5 && om < 6)
      {
         printf("Dva studenta su polozila.");
      }
      else if (ob < 6 && ot > 5 && om > 5)
      {
         printf("Dva studenta su polozila.");
      }
      else if (ob > 5 && ot < 6 && om > 5)
      {
         printf("Dva studenta su polozila.");
      }
      else if (ob > 5 && ot < 6 && om < 6)
      {
         printf("Jedan student je polozio.");
      }
      else if (ob < 6 && ot > 5 && om < 6)
      {
         printf("Jedan student je polozio.");
      }
      else if (ob < 6 && ot < 6 && om > 5)
      {
         printf("Jedan student je polozio.");
      }
      else if (ob < 6 && ot < 6 && om < 6)
      {
      ...
      if (ob > 5 && om > 5 && om > 5)
      {
         if (fabs(ot - ob) < E && fabs(ot - om) < E && fabs(ob - om) < E)
         {
            printf("\nSva tri studenta imaju istu ocjenu.");
         }
         else if (fabs(ot - ob) < E && fabs(ob - om) > E)
         {
         ...
         else if (fabs(ot - om) < E && fabs(ob - om) > E)
         {
            printf("\nDva od tri studenta imaju istu ocjenu.");
         }
         else if (fabs(ot - om) > E && fabs(ot - ob) > E && fabs(ob - om) > E)
         {

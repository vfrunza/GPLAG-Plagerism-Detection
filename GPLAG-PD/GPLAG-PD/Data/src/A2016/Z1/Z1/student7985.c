...
int main()
{
   ...
   printf("I parcijalni ispit: "); scanf("%lf", &ipi); if (ipi < 0.0 || ipi > 20.0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: "); scanf("%lf", &iipi); if (iipi < 0.0 || iipi > 20.0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: "); scanf("%lf", &p); if (p < 0.0 || p > 10.0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zadace: "); scanf("%lf", &z); if (z < 0.0 || z > 10.0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zavrsni ispit: "); scanf("%lf", &zi); if (zi < 0.0 || zi > 40.0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   ...
   if (((sumaM < 55.0 && sumaB < 55.0 && sumaT >= 55.0) || (sumaM < 55.0 && sumaB >= 55.0 && sumaT < 55.0)) || (sumaM >= 55.0 && sumaB < 55.0 && sumaT < 55.0))
   {

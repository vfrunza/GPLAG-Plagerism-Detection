...
/*	printf("Zadaća 1, Zadatak 1");*/
   ...
   else if ((z1 >= 55 && z2 < 55 && z3 < 55) || (z2 >= 55 && z1 < 55 && z3 < 55) || (z3 >= 55 && z1 < 55 && z2 < 55))
   {
      printf("Jedan student je polozio.");
   }
   else if ((z1 >= 55 && z2 >= 55 && z3 < 55) || (z2 >= 55 && z3 >= 55 && z1 < 55) || (z1 >= 55 && z3 >= 55 && z2 < 55))
   {
   ...
   if (z1 >= 55 && z2 >= 55 && z3 >= 55)
   {
      ...
      if (ocjena == ocjena2 && ocjena2 == ocjena3 && ocjena == ocjena3)
      {
         printf("\nSva tri studenta imaju istu ocjenu.");
      }
      if ((ocjena == ocjena2 && ocjena2 != ocjena3 && ocjena != ocjena3) || (ocjena == ocjena3 && ocjena3 != ocjena2 && ocjena != ocjena2) || (ocjena2 == ocjena3 && ocjena3 != ocjena && ocjena2 != ocjena))
      {

...
int main()
{
   ...
   else if ((ot > 5 || ot <= 10) && ob == 0 && om == 0)
   {
      printf("Jedan student je polozio.");
   }
   else if ((ob > 5 || ob <= 10) && ot == 0 && om == 0)
   {
      printf("Jedan student je polozio.");
   }
   else if ((om > 5 || om <= 10) && ob == 0 && ot == 0)
   {
      printf("Jedan student je polozio.");
   }
   else if ((ot > 5 || ot <= 10) && (ob > 5 || ob <= 10) && om == 0)
   {
      printf("Dva studenta su polozila.");
   }
   else if ((ot > 5 || ot <= 10) && (om > 5 || om <= 10) && ob == 0)
   {
      printf("Dva studenta su polozila.");
   }
   else if ((ob > 5 || ob <= 10) && (om > 5 || om <= 10) && ot == 0)
   {
      printf("Dva studenta su polozila.");
   }
   else

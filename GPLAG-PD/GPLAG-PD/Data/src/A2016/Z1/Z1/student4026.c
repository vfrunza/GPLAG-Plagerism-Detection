...
int main()
{
   ...
   if (mb < 0 || mb > 20)
   {
      printf("Neiapravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   scanf("%f", &mp);
   if (mp < 0 || mp > 10)
   ...
   if (tu >= 55 && bu >= 55 && mu >= 55)
   {
      ...
      else if ((Tarik == Bojan) && (Tarik == Mirza) && (Bojan == Mirza))
      {
         printf("Sva tri studenta imaju istu ocjenu.");
      }
      else if (((Tarik == Bojan) && (Bojan != Mirza)) || ((Tarik == Mirza) && (Tarik != Bojan)) || ((Bojan == Mirza) && (Bojan != Tarik)))
      {

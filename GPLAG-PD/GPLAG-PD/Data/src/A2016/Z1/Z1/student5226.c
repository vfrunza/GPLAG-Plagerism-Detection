...
int main()
{
   ...
   if (Tarik_Iparcijala < 0 || Tarik_Iparcijala > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni: ");
   scanf("%f", &Tarik_IIparcijala);
   if (Tarik_IIparcijala < 0 || Tarik_IIparcijala > 20)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("Prisustvo: ");
   ...
   if (Tarik_Zadace < 0 || Tarik_Zadace > 10)
   {
      printf("Neispravan broj bodova."); return(0);
   }
   printf("Zavrsni ispit: ");
   scanf("%f", &Tarki_ZavrsniIspit);
   if (Tarki_ZavrsniIspit < 0 || Tarki_ZavrsniIspit > 40)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   ...
   if (Bojan_Iparcijala < 0 || Bojan_Iparcijala > 20)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("II parcijala: ");
   scanf("%f", &Bojan_IIparcijala);
   if (Bojan_IIparcijala < 0 || Bojan_IIparcijala > 20)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("Prisustvo: ");
   ...
   if (Bojan_Zadace < 0 || Bojan_Zadace > 10)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("Zavrsni ispit: ");
   scanf("%f", &Bojan_ZavrsniIspit);
   if (Bojan_ZavrsniIspit < 0 || Bojan_ZavrsniIspit > 40)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   ...
   if (Mirza_Iparcijalni < 0 || Mirza_Iparcijalni > 20)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("II parcijalni: ");
   scanf("%f", &Mirza_IIparcijalni);
   if (Mirza_IIparcijalni < 0 || Mirza_IIparcijalni > 20)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("Prisustvo: ");
   ...
   if (Mirza_Zadace < 0 || Mirza_Zadace > 10)
   {
      printf("Neispravan broj bodova. "); return(0);
   }
   printf("Zavrsni ispit: ");
   scanf("%f", &Mirza_ZavrsniIspit);
   if (Mirza_ZavrsniIspit < 0 || Mirza_ZavrsniIspit > 40)
   {
      printf("Neispravan broj bodova. "); return(0);
   }

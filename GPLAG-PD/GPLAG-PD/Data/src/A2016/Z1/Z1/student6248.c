...
int main()
{
   ...
   if (tarik_bodovi >= 0 && tarik_bodovi < 55)
   {
      tarik_pao = 1;
   }
   else if (tarik_bodovi >= 55 && tarik_bodovi < 65)
   {
      tarik_ocjena = 6;
   }
   ...
   else if (tarik_bodovi >= 85 && tarik_bodovi < 92)
   {
      tarik_ocjena = 9;
   }
   else if (tarik_bodovi >= 92 && tarik_bodovi <= 100)
   {
      tarik_ocjena = 10;
   }
   if (bojan_bodovi >= 0 && bojan_bodovi < 55)
   {
      bojan_pao = 1;
   }
   else if (bojan_bodovi >= 55 && bojan_bodovi < 65)
   {
      bojan_ocjena = 6;
   }
   ...
   else if (bojan_bodovi >= 85 && bojan_bodovi < 92)
   {
      bojan_ocjena = 9;
   }
   else if (bojan_bodovi >= 92 && bojan_bodovi <= 100)
   {
      bojan_ocjena = 10;
   }
   if (mirza_bodovi >= 0 && mirza_bodovi < 55)
   {
      mirza_pao = 1;
   }
   else if (mirza_bodovi >= 55 && mirza_bodovi < 65)
   {
      mirza_ocjena = 6;
   }
   ...
   else if (mirza_bodovi >= 85 && mirza_bodovi < 92)
   {
      mirza_ocjena = 9;
   }
   else if (mirza_bodovi >= 92 && mirza_bodovi <= 100)
   {
      mirza_ocjena = 10;
   }

   if (tarik_pao == 1 && bojan_pao == 1 && mirza_pao == 1)
   {
   ...
   else if (tarik_pao != 1 && bojan_pao != 1 && mirza_pao != 1)
   {
      ...
      if (tarik_ocjena == bojan_ocjena && bojan_ocjena == mirza_ocjena && tarik_ocjena == mirza_ocjena)
      {
      ...
      else if (tarik_ocjena != bojan_ocjena && bojan_ocjena != mirza_ocjena && mirza_ocjena != tarik_ocjena)
      {

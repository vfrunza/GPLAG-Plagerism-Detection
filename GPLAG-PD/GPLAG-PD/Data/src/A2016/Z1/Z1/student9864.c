...
int main()
{
   ...
   /*printf("\n\n %lf \n\n", nm);*/
   if ((nt > 55 || Poredi(55, nt)) && (nt < 65 && !Poredi(65, nt)))
   {
      ocjena1 = 6;
   }
   if ((nt > 65 || Poredi(65, nt)) && (nt < 75 && !Poredi(75, nt)))
   {
      ocjena1 = 7;
   }
   if ((nt > 75 || Poredi(75, nt)) && (nt < 85 && !Poredi(85, nt)))
   {
      ocjena1 = 8;
   }
   if ((nt > 85 || Poredi(85, nt)) && (nt < 92 && !Poredi(92, nt)))
   {
      ocjena1 = 9;
   }
   if ((nt > 92 || Poredi(92, nt)) && (nt < 100 || Poredi(100, nt)))
   {
      ocjena1 = 10;
   }
   if ((nb > 55 || Poredi(55, nb)) && (nb < 65 && !Poredi(65, nb)))
   {
      ocjena2 = 6;
   }
   if ((nb > 65 || Poredi(65, nb)) && (nb < 75 && !Poredi(75, nb)))
   {
      ocjena2 = 7;
   }
   if ((nb > 75 || Poredi(75, nb)) && (nb < 85 && !Poredi(85, nb)))
   {
      ocjena2 = 8;
   }
   if ((nb > 85 || Poredi(85, nb)) && (nb < 92 && !Poredi(92, nb)))
   {
      ocjena2 = 9;
   }
   if ((nb > 92 || Poredi(92, nb)) && (nb < 100 || Poredi(100, nb)))
   {
      ocjena2 = 10;
   }
   if ((nm > 55 || Poredi(55, nm)) && (nm < 65 && !Poredi(65, nm)))
   {
      ocjena3 = 6;
   }
   if ((nm > 65 || Poredi(65, nm)) && (nm < 75 && !Poredi(75, nm)))
   {
      ocjena3 = 7;
   }
   if ((nm > 75 || Poredi(75, nm)) && (nm < 85 && !Poredi(85, nm)))
   {
      ocjena3 = 8;
   }
   if ((nm > 85 || Poredi(85, nm)) && (nm < 92 && !Poredi(92, nm)))
   {
      ocjena3 = 9;
   }
   if ((nm > 92 || Poredi(92, nm)) && (nm < 100 || Poredi(100, nm)))
   {
      ocjena3 = 10;
   }

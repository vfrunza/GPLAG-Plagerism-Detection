...
int main()
{
   ...
   else if (T_SB >= 55 && T_SB < 65)
   {
      ocjena1 = 6;
   }
   else if (T_SB >= 65 && T_SB < 75)
   {
      ocjena1 = 7;
   }
   else if (T_SB >= 75 && T_SB < 85)
   {
      ocjena1 = 8;
   }
   else if (T_SB >= 85 && T_SB < 92)
   {
      ocjena1 = 9;
   }
   else
   ...
   else if (B_SB >= 55 && B_SB < 65)
   {
      ocjena2 = 6;
   }
   else if (B_SB >= 65 && B_SB < 75)
   {
      ocjena2 = 7;
   }
   else if (B_SB >= 75 && B_SB < 85)
   {
      ocjena2 = 8;
   }
   else if (B_SB >= 85 && B_SB < 92)
   {
      ocjena2 = 9;
   }
   else
   ...
   else if (M_SB >= 55 && M_SB < 65)
   {
      ocjena3 = 6;
   }
   else if (M_SB >= 65 && M_SB < 75)
   {
      ocjena3 = 7;
   }
   else if (M_SB >= 75 && M_SB < 85)
   {
      ocjena3 = 8;
   }
   else if (M_SB >= 85 && M_SB < 92)
   {
      ocjena3 = 9;
   }
   else

...
int main()
{
   ...
   if (sumTarik >= 55 && sumTarik < 65)
   {
      ocjenaTarik = 6;
   }
   if (sumTarik >= 65 && sumTarik < 75)
   {
      ocjenaTarik = 7;
   }
   if (sumTarik >= 75 && sumTarik < 85)
   {
      ocjenaTarik = 8;
   }
   if (sumTarik >= 85 && sumTarik < 92)
   {
      ocjenaTarik = 9;
   }
   if (sumTarik >= 92 && sumTarik <= 100)
   {
      ocjenaTarik = 10;
   }
   ...
   if (sumBojan >= 55 && sumBojan < 65)
   {
      ocjenaBojan = 6;
   }
   if (sumBojan >= 65 && sumBojan < 75)
   {
      ocjenaBojan = 7;
   }
   if (sumBojan >= 75 && sumBojan < 85)
   {
      ocjenaBojan = 8;
   }
   if (sumBojan >= 85 && sumBojan < 92)
   {
      ocjenaBojan = 9;
   }
   if (sumBojan >= 92 && sumBojan <= 100)
   {
      ocjenaBojan = 10;
   }
   ...
   if (sumMirza >= 55 && sumMirza < 65)
   {
      ocjenaMirza = 6;
   }
   if (sumMirza >= 65 && sumMirza < 75)
   {
      ocjenaMirza = 7;
   }
   if (sumMirza >= 75 && sumMirza < 85)
   {
      ocjenaMirza = 8;
   }
   if (sumMirza >= 85 && sumMirza < 92)
   {
      ocjenaMirza = 9;
   }
   if (sumMirza >= 92 && sumMirza <= 100)
   {
      ocjenaMirza = 10;
   }

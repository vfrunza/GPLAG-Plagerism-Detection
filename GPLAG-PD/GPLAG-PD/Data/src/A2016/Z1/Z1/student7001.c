...
int main()
{
   ...
   else if (o_t >= 55 && o_t < 65)
   {
      o_6++;
   }
   else if (o_t >= 65 && o_t < 75)
   {
      o_7++;
   }
   else if (o_t >= 75 && o_t < 85)
   {
      o_8++;
   }
   else if (o_t >= 85 && o_t < 92)
   {
      o_9++;
   }
   else
   ...
   else if (o_b >= 55 && o_b < 65)
   {
      o_6++;
   }
   else if (o_b >= 65 && o_b < 75)
   {
      o_7++;
   }
   else if (o_b >= 75 && o_b < 85)
   {
      o_8++;
   }
   else if (o_b >= 85 && o_b < 92)
   {
      o_9++;
   }
   else
   ...
   else if (o_m >= 55 && o_m < 65)
   {
      o_6++;
   }
   else if (o_m >= 65 && o_m < 75)
   {
      o_7++;
   }
   else if (o_m >= 75 && o_m < 85)
   {
      o_8++;
   }
   else if (o_m >= 85 && o_m < 92)
   {
      o_9++;
   }
   else
   ...
   if (o_6 == 3 || o_7 == 3 || o_8 == 3 || o_9 == 3 || o_10 == 3)
   {
      printf("\nSva tri studenta imaju istu ocjenu.");
   }
   else if (o_6 == 2 || o_7 == 2 || o_8 == 2 || o_9 == 2 || o_10 == 2)
   {

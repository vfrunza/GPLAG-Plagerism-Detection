...
int main()
{
   ...
   scanf("%f", &tarikp1);
   if (tarikp1 > 20 || tarikp1 < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%f", &tarikp2);
   if (tarikp2 > 20 || tarikp2 < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   scanf("%f", &tarikpris);
   if (tarikpris > 10 || tarikpris < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zadace: ");
   scanf("%f", &tarikz);
   if (tarikz > 10 || tarikz < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zavrsni ispit: ");
   scanf("%f", &tarikispit);
   if (tarikispit > 40 || tarikispit < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   ...
   printf("I parcijalni ispit: ");
   scanf("%f", &bojanp1);
   if (bojanp1 > 20 || bojanp1 < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%f", &bojanp2);
   if (bojanp2 > 20 || bojanp2 < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   scanf("%f", &bojanpris);
   if (bojanpris > 10 || bojanpris < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zadace: ");
   scanf("%f", &bojanz);
   if (bojanz > 10 || bojanz < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zavrsni ispit: ");
   scanf("%f", &bojanispit);
   if (bojanispit > 40 || bojanispit < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   ...
   printf("I parcijalni ispit: ");
   scanf("%f", &mirzap1);
   if (mirzap1 > 20 || mirzap1 < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%f", &mirzap2);
   if (mirzap2 > 20 || mirzap2 < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   scanf("%f", &mirzapris);
   if (mirzapris > 10 || mirzapris < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zadace: ");
   scanf("%f", &mirzaz);
   if (mirzaz > 10 || mirzaz < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Zavrsni ispit: ");
   scanf("%f", &mirzaispit);
   if (mirzaispit > 40 || mirzaispit < 0)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   ...
   else if (tarik != 5 && bojan != 5 && mirza != 5)
   {
      ...
      else if (tarik != mirza && tarik != bojan && bojan != mirza)
      {
   ...
   else if (bojan == 5 && (tarik != 5 && mirza != 5))
   {
      printf("Dva studenta su polozila.\n");
   }
   else if (mirza == 5 && (bojan != 5 && tarik != 5))
   {
      printf("Dva studenta su polozila.\n");
   }
   else

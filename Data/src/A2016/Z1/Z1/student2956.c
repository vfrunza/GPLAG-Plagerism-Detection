...
int main()
{
   ...
   if ((tarik > 55 && bojan < 55 && mirza < 55) || (bojan > 55 && tarik < 55 && mirza < 55) || (mirza > 55 && tarik < 55 && bojan < 55))
   {
      printf("Jedan student je polozio"); return(0);
   }
   if ((tarik > 55 && bojan > 55 && mirza < 55) || (tarik > 55 && mirza > 55 && bojan < 55) || (bojan > 55 && mirza > 55 && tarik < 55))
   {

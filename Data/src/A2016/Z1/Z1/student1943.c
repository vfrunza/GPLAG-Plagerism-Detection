...
int main()
{
   ...
   if (bodovi1 >= 55 && bodovi1 < 65)
   {
      ocjena1 = 6;
   }
   else if (bodovi1 >= 65 && bodovi1 < 75)
   {
      ocjena1 = 7;
   }
   else if (bodovi1 >= 75 && bodovi1 < 85)
   {
      ocjena1 = 8;
   }
   else if (bodovi1 >= 85 && bodovi1 < 92)
   {
      ocjena1 = 9;
   }
   else if (bodovi1 >= 92 && bodovi1 <= 100)
   {
      ocjena1 = 10;
   }
   else
   ...
   if (bodovi2 >= 55 && bodovi2 < 65)
   {
      ocjena2 = 6;
   }
   else if (bodovi2 >= 65 && bodovi2 < 75)
   {
      ocjena2 = 7;
   }
   else if (bodovi2 >= 75 && bodovi2 < 85)
   {
      ocjena2 = 8;
   }
   else if (bodovi2 >= 85 && bodovi2 < 92)
   {
      ocjena2 = 9;
   }
   else if (bodovi2 >= 92 && bodovi2 <= 100)
   {
      ocjena2 = 10;
   }
   else
   ...
   if (bodovi3 >= 55 && bodovi3 < 65)
   {
      ocjena3 = 6;
   }
   else if (bodovi3 >= 65 && bodovi3 < 75)
   {
      ocjena3 = 7;
   }
   else if (bodovi3 >= 75 && bodovi3 < 85)
   {
      ocjena3 = 8;
   }
   else if (bodovi3 >= 85 && bodovi3 < 92)
   {
      ocjena3 = 9;
   }
   else if (bodovi3 >= 92 && bodovi3 <= 100)
   {
      ocjena3 = 10;
   }
   else

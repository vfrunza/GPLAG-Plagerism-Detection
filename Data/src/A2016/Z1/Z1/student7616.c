...
int main()
{
   ...
   scanf("%lf", &prvi_par1);
   if (prvi_par1 < 0 || prvi_par1 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &drugi_par1);
   if (drugi_par1 < 0 || drugi_par1 > 20)
   {
      printf("Neispravan broj bodova");  return(0);
   }
   printf("Prisustvo: ");
   ...
   printf("I parcijalni ispit: ");
   scanf("%lf", &prvi_par2);
   if (prvi_par2 < 0 || prvi_par2 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &drugi_par2);
   if (drugi_par2 < 0 || drugi_par2 > 20)
   {
      printf("Neispravan broj bodova");  return(0);
   }
   printf("Prisustvo: ");
   ...
   printf("I parcijalni ispit: ");
   scanf("%lf", &prvi_par3);
   if (prvi_par3 < 0 || prvi_par3 > 20)
   {
      printf("Neispravan broj bodova");  return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &drugi_par3);
   if (drugi_par3 < 0 || drugi_par3 > 20)
   {
      printf("Neispravan broj bodova");  return(0);
   }
   printf("Prisustvo: ");

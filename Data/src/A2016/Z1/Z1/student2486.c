...
int main()
{
   ...
   if (ukupnoT >= 55 && ukupnoT < 65)
   {
      ocjenaT = 6;
   }
   if (ukupnoT >= 65 && ukupnoT < 75)
   {
      ocjenaT = 7;
   }
   if (ukupnoT >= 75 && ukupnoT < 85)
   {
      ocjenaT = 8;
   }
   if (ukupnoT >= 85 && ukupnoT < 95)
   {
      ocjenaT = 9;
   }
   if (ukupnoT >= 95 && ukupnoT <= 100)
   {
      ocjenaT = 10;
   }

   ukupnoB = IparcB + IIparcB + prisustvoB + zadaceB + zavrsniB + GRESKA;
   if (ukupnoB >= 55 && ukupnoB < 65)
   {
      ocjenaB = 6;
   }
   if (ukupnoB >= 65 && ukupnoB < 75)
   {
      ocjenaB = 7;
   }
   if (ukupnoB >= 75 && ukupnoB < 85)
   {
      ocjenaB = 8;
   }
   if (ukupnoB >= 85 && ukupnoB < 95)
   {
      ocjenaB = 9;
   }
   if (ukupnoB >= 95 && ukupnoB <= 100)
   {
      ocjenaB = 10;
   }

   ukupnoM = IparcM + IIparcM + prisustvoM + zadaceM + zavrsniM + GRESKA;
   if (ukupnoM >= 55 && ukupnoM < 65)
   {
      ocjenaM = 6;
   }
   if (ukupnoM >= 65 && ukupnoM < 75)
   {
      ocjenaM = 7;
   }
   if (ukupnoM >= 75 && ukupnoM < 85)
   {
      ocjenaM = 8;
   }
   if (ukupnoM >= 85 && ukupnoM < 95)
   {
      ocjenaM = 9;
   }
   if (ukupnoM >= 95 && ukupnoM <= 100)
   {
      ocjenaM = 10;
   }

...
int main()
{
   ...
   if (mbt == 3)
   {
      ...
      else if (ocjenat == ocjenam && ocjenam == ocjenab && ocjenat == ocjenab)
      {
         printf("Sva tri studenta imaju istu ocjenu.\n");
      }
      else if (ocjenat == ocjenab && ocjenam != ocjenat)
      {
         printf("Dva od tri studenta imaju istu ocjenu.\n");
      }
      else if (ocjenam == ocjenab && ocjenab != ocjenat)
      {
         printf("Dva od tri studenta imaju istu ocjenu.\n");
      }
      else if (ocjenat == ocjenam && ocjenam != ocjenab)
      {
         printf("Dva od tri studenta imaju razlicitu ocjenu.\n");
      }
   }

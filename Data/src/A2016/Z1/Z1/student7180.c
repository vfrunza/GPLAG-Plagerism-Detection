...
int main()
{
   ...
   if (tu < 55)
   {
      tpolozio = 0; tocjena = 0;
   }
   else if (tu >= 55 && tu < 65)
   {
      tpolozio = 1; tocjena = 6;
   }
   else if (tu >= 65 && tu < 75)
   {
      tpolozio = 1; tocjena = 7;
   }
   else if (tu >= 75 && tu < 85)
   {
      tpolozio = 1; tocjena = 8;
   }
   else if (tu >= 85 && tu < 92)
   {
      tpolozio = 1; tocjena = 9;
   }
   else if (tu >= 92 && tu <= 100)
   {
      tpolozio = 1; tocjena = 10;
   }

   if (bu < 55)
   {
      bpolozio = 0; bocjena = 0;
   }
   else if (bu >= 55 && bu < 65)
   {
      bpolozio = 1; bocjena = 6;
   }
   else if (bu >= 65 && bu < 75)
   {
      bpolozio = 1; bocjena = 7;
   }
   else if (bu >= 75 && bu < 85)
   {
      bpolozio = 1; bocjena = 8;
   }
   else if (bu >= 85 && bu < 92)
   {
      bpolozio = 1; bocjena = 9;
   }
   else if (bu >= 92 && bu <= 100)
   {
      bpolozio = 1; bocjena = 10;
   }

   if (mu < 55)
   {
      mpolozio = 0; mocjena = 0;
   }
   else if (mu >= 55 && mu < 65)
   {
      mpolozio = 1; mocjena = 6;
   }
   else if (mu >= 65 && mu < 75)
   {
      mpolozio = 1; mocjena = 7;
   }
   else if (mu >= 75 && mu < 85)
   {
      mpolozio = 1; mocjena = 8;
   }
   else if (mu >= 85 && mu < 92)
   {
      mpolozio = 1; mocjena = 9;
   }
   else if (mu >= 92 && mu <= 100)
   {
      mpolozio = 1; mocjena = 10;
   }
   ...
   else if (tpolozio + mpolozio + bpolozio == 2)
   {
      printf("Dva studenta su polozila.\n");
   }
   else if (tpolozio + mpolozio + bpolozio == 1)
   {

...
int main()
{
   ...
   if (ukupnotarik >= (55 - e) && ukupnotarik < (65 - e))
   {
      ocjenatarik = 6;
   }
   else if (ukupnotarik >= (65 - e) && ukupnotarik < (75 - e))
   {
      ocjenatarik = 7;
   }
   else if (ukupnotarik >= (75 - e) && ukupnotarik < (85 - e))
   {
      ocjenatarik = 8;
   }
   else if (ukupnotarik >= (85 - e) && ukupnotarik < (92 - e))
   {
      ocjenatarik = 9;
   }
   else if (ukupnotarik >= (92 - e) && ukupnotarik < (100 - e))
   {
      ocjenatarik = 10;
   }

   if (ukupnobojan >= (55 - e) && ukupnobojan < (65 - e))
   {
      ocjenabojan = 6;
   }
   else if (ukupnobojan >= (65 - e) && ukupnobojan < (75 - e))
   {
      ocjenabojan = 7;
   }
   else if (ukupnobojan >= (75 - e) && ukupnobojan < (85 - e))
   {
      ocjenabojan = 8;
   }
   else if (ukupnobojan >= (85 - e) && ukupnobojan < (92 - e))
   {
      ocjenabojan = 9;
   }
   else if (ukupnobojan >= (92 - e) && ukupnobojan < (100 - e))
   {
      ocjenabojan = 10;
   }

   if (ukupnomirza >= (55 - e) && ukupnomirza < (65 - e))
   {
      ocjenamirza = 6;
   }
   else if (ukupnomirza >= (65 - e) && ukupnomirza < (75 - e))
   {
      ocjenamirza = 7;
   }
   else if (ukupnomirza >= (75 - e) && ukupnomirza < (85 - e))
   {
      ocjenamirza = 8;
   }
   else if (ukupnomirza >= (85 - e) && ukupnomirza < (92 - e))
   {
      ocjenamirza = 9;
   }
   else if (ukupnomirza >= (92 - e) && ukupnomirza < (100 - e))
   {
      ocjenamirza = 10;
   }

...
int main()
{
   ...
   scanf("%lf", &Tp1); if (Tp1 < 0 || Tp1 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &Tp2); if (Tp2 < 0 || Tp2 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   printf("I parcijalni ispit: ");
   scanf("%lf", &Bp1); if (Bp1 < 0 || Bp1 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &Bp2); if (Bp2 < 0 || Bp2 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   printf("I parcijalni ispit: ");
   scanf("%lf", &Mp1); if (Mp1 < 0 || Mp1 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &Mp2); if (Mp2 < 0 || Mp2 > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   else if (Toc > 5 && Boc > 5 && Moc > 5)
   {
      ...
      if ((Tb > 55 && Bb > 55 && Mb > 55) && (Toc == Boc && Boc == Moc))
      {

...
int main()
{
   ...
   else if ((T == '5' && M == '5' && B != '5') || (T == '5' && B == '5' && M != '5') || (T != '5' && M == '5' && B == '5'))
   {
      printf("Jedan student je polozio.");
   }
   else if ((T != '5' && M != '5' && B == '5') || (T != '5' && M == '5' && B != '5') || (T == '5' && M != '5' && B != '5'))
   {
   ...
   else if (T != '5' && M != '5' && B != '5')
   {
      ...
      if ((fabs(T - M) < EPS) && (fabs(T - B) < EPS))
      {
         printf("\nSva tri studenta imaju istu ocjenu.");
      }
      else if ((fabs(T - M) < EPS && T != B && M != B) || (fabs(T - B) < EPS && T != M && B != M) || (fabs(B - M) < EPS && T != B && M != T))
      {

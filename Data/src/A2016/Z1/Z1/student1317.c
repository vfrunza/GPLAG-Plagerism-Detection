...
int main()
{
   ...
   /* Definisanje ocjena */
   if (suma1 >= 55.0f && suma1 < 65.0f)
   {
      ocjena1 = 6;
   }
   else if (suma1 >= 65.0f && suma1 < 75.0f)
   {
      ocjena1 = 7;
   }
   else if (suma1 >= 75.0f && suma1 < 85.0f)
   {
      ocjena1 = 8;
   }
   else if (suma1 >= 85.0f && suma1 < 92.0f)
   {
      ocjena1 = 9;
   }
   else if (suma1 >= 92.0f && suma1 <= 100.0f)
   {
      ocjena1 = 10;
   }

   if (suma2 >= 55.0f && suma2 < 65.0f)
   {
      ocjena2 = 6;
   }
   else if (suma2 >= 65.0f && suma2 < 75.0f)
   {
      ocjena2 = 7;
   }
   else if (suma2 >= 75.0f && suma2 < 85.0f)
   {
      ocjena2 = 8;
   }
   else if (suma2 >= 85.0f && suma2 < 92.0f)
   {
      ocjena2 = 9;
   }
   else if (suma2 >= 92.0f && suma2 <= 100.0f)
   {
      ocjena2 = 10;
   }

   if (suma3 >= 55.0f && suma3 < 65.0f)
   {
      ocjena3 = 6;
   }
   else if (suma3 >= 65.0f && suma3 < 75.0f)
   {
      ocjena3 = 7;
   }
   else if (suma3 >= 75.0f && suma3 < 85.0f)
   {
      ocjena3 = 8;
   }
   else if (suma3 >= 85.0f && suma3 < 92.0f)
   {
      ocjena3 = 9;
   }
   else if (suma3 >= 92.0f && suma3 <= 100.0f)
   {
      ocjena3 = 10;
   }

   /* Ispitivanje koliko je studenata polozilo */
   if (suma1 >= 55.0f && suma2 < 55.0f && suma3 < 55.0f)
   {
   ...
   else if (suma1 >= 55.0f && suma2 >= 55.0f && suma3 >= 55.0f)
   {
      ...
      else if (ocjena1 == ocjena2 && ocjena1 != ocjena3)
      {
         printf("\nDva od tri studenta imaju istu ocjenu.");
      }
      else if (ocjena1 == ocjena3 && ocjena1 != ocjena2)
      {
         printf("\nDva od tri studenta imaju istu ocjenu.");
      }
      else if (ocjena2 == ocjena3 && ocjena2 != ocjena1)
      {
         printf("\nDva od tri studenta imaju istu ocjenu.");
      }
   }

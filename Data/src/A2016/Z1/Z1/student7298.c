...
int main()
{
   ...
   if (prvi_parcijalni_Tarik < 0 || prvi_parcijalni_Tarik > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &drugi_parcijalni_Tarik);
   if (drugi_parcijalni_Tarik < 0 || drugi_parcijalni_Tarik > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   if (prvi_parcijalni_Bojan < 0 || prvi_parcijalni_Bojan > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &drugi_parcijalni_Bojan);
   if (drugi_parcijalni_Bojan < 0 || drugi_parcijalni_Bojan > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   if (prvi_parcijalni_Mirza < 0 || prvi_parcijalni_Mirza > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &drugi_parcijalni_Mirza);
   if (drugi_parcijalni_Mirza < 0 || drugi_parcijalni_Mirza > 20)
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   if ((zbir_Tarik >= 55 && zbir_Bojan < 55 && zbir_Mirza < 55) || (zbir_Tarik < 55 && zbir_Bojan >= 55 && zbir_Mirza < 55) ||
       (zbir_Tarik < 55 && zbir_Bojan < 55 && zbir_Mirza >= 55))
   {
   ...
   else if (zbir_Tarik >= 55 && zbir_Bojan >= 55 && zbir_Mirza >= 55)
   {
       ...
       (zbir_Tarik >= 92 && zbir_Tarik <= 100 && zbir_Bojan >= 92 && zbir_Bojan <= 100 && zbir_Mirza >= 92 && zbir_Mirza <= 100))
   {
      printf("Sva tri studenta imaju istu ocjenu.");
            ...
            (zbir_Mirza >= 92 && zbir_Mirza <= 100 && zbir_Bojan >= 92 && zbir_Bojan <= 100))
   {
      printf("Dva od tri studenta imaju istu ocjenu.");
   }
   else if (zbir_Tarik < 55 || zbir_Mirza < 55 || zbir_Bojan < 55)
   {
      return(0);
   }
   else

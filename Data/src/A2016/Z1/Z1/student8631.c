...
int main()
{
   ...
   else if (ukupnibrojocjena == 3)
   {
      ...
      else if (SUMT < 92 && SUMT >= 85)
      {
         O9++;
      }
      else if (SUMT < 85 && SUMT >= 75)
      {
         O8++;
      }
      else if (SUMT < 75 && SUMT >= 65)
      {
         O7++;
      }
      else
      ...
      else if (SUMB < 92 && SUMB >= 85)
      {
         O9++;
      }
      else if (SUMB < 85 && SUMB >= 75)
      {
         O8++;
      }
      else if (SUMB < 75 && SUMB >= 65)
      {
         O7++;
      }
      else
      ...
      else if (SUMM < 92 && SUMM >= 85)
      {
         O9++;
      }
      else if (SUMM < 85 && SUMM >= 75)
      {
         O8++;
      }
      else if (SUMM < 75 && SUMM >= 65)
      {
         O7++;
      }
      else

...
int main()
{
   ...
   if (broj_koliko_je_polozilo == 0)
   {
      printf("Nijedan student nije polozio.\n");
   }
   else if (broj_koliko_je_polozilo == 1)
   {
      printf("Jedan student je polozio.\n");
   }
   else if (broj_koliko_je_polozilo == 2)
   {
      printf("Dva studenta su polozila.\n");
   }
   else if (broj_koliko_je_polozilo == 3)
   {
   ...
   if (ocjena1 != ocjena2)
   {
      if (ocjena2 == ocjena3)
      {
         broj_razlicitih_ocjena = 2;
      }
      else if (ocjena2 != ocjena3)
      {
         broj_razlicitih_ocjena = 3;
      }
   }
   ...
   {
      if (broj_razlicitih_ocjena == 1)
      {
         printf("Sva tri studenta imaju istu ocjenu.\n");
      }
      else if (broj_razlicitih_ocjena == 2)
      {
         printf("Dva od tri studenta imaju istu ocjenu.\n");
      }
      else if (broj_razlicitih_ocjena == 3)
      {

...
int main()
{
   ...
   scanf("%lf", &p1T); if ((p1T < 0) || (p1T > 20))
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &p2T); if ((p2T < 0) || (p2T > 20))
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   printf("I parcijalni ispit: ");
   scanf("%lf", &p1B); if ((p1B < 0) || (p1B > 20))
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &p2B); if ((p2B < 0) || (p2B > 20))
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");
   ...
   printf("I parcijalni ispit: ");
   scanf("%lf", &p1M); if ((p1M < 0) || (p1M > 20))
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("II parcijalni ispit: ");
   scanf("%lf", &p2M); if ((p2M < 0) || (p2M > 20))
   {
      printf("Neispravan broj bodova"); return(0);
   }
   printf("Prisustvo: ");

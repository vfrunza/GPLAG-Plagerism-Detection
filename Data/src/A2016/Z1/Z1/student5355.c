...
int main()
{
   ...
   if (suma_tarik >= 65 && suma_tarik < 75)
   {
      ocjena_tarik = 7;
   }
   if (suma_tarik >= 75 && suma_tarik < 85)
   {
      ocjena_tarik = 8;
   }
   if (suma_tarik >= 85 && suma_tarik < 92)
   {
      ocjena_tarik = 9;
   }
   if (suma_tarik >= 92 && suma_tarik < 100)
   {
      ocjena_tarik = 10;
   }
   ...
   if (suma_bojan >= 65 && suma_bojan < 75)
   {
      ocjena_bojan = 7;
   }
   if (suma_bojan >= 75 && suma_bojan < 85)
   {
      ocjena_bojan = 8;
   }
   if (suma_bojan >= 85 && suma_bojan < 92)
   {
      ocjena_bojan = 9;
   }
   if (suma_bojan >= 92 && suma_bojan < 100)
   {
      ocjena_bojan = 10;
   }
   ...
   if (suma_mirza >= 65 && suma_mirza < 75)
   {
      ocjena_mirza = 7;
   }
   if (suma_mirza >= 75 && suma_mirza < 85)
   {
      ocjena_mirza = 8;
   }
   if (suma_mirza >= 85 && suma_mirza < 92)
   {
      ocjena_mirza = 9;
   }
   if (suma_mirza >= 92 && suma_mirza < 100)
   {
      ocjena_mirza = 10;
   }
   ...
   if (broj_polozenih == 3)
   {
      if (ocjena_tarik == ocjena_bojan == ocjena_mirza)
      {

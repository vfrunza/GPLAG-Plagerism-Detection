...
int main()
{
   ...
   if (UkupnoTarik >= 55 && UkupnoTarik < 65)
   {
      ocjenaTarik = 6;
   }
   if (UkupnoTarik >= 65 && UkupnoTarik < 75)
   {
      ocjenaTarik = 7;
   }
   if (UkupnoTarik >= 75 && UkupnoTarik < 85)
   {
      ocjenaTarik = 8;
   }
   if (UkupnoTarik >= 85 && UkupnoTarik < 92)
   {
      ocjenaTarik = 9;
   }
   if (UkupnoTarik >= 92 && UkupnoTarik < 100)
   {
      ocjenaTarik = 10;
   }
   ...
   if (UkupnoBojan >= 55 && UkupnoBojan < 65)
   {
      ocjenaBojan = 6;
   }
   if (UkupnoBojan >= 65 && UkupnoBojan < 75)
   {
      ocjenaBojan = 7;
   }
   if (UkupnoBojan >= 75 && UkupnoBojan < 85)
   {
      ocjenaBojan = 8;
   }
   if (UkupnoBojan >= 85 && UkupnoBojan < 92)
   {
      ocjenaBojan = 9;
   }
   if (UkupnoBojan >= 92 && UkupnoBojan < 100)
   {
      ocjenaBojan = 10;
   }
   ...
   if (UkupnoMirza >= 55 && UkupnoMirza < 65)
   {
      ocjenaMirza = 6;
   }
   if (UkupnoMirza >= 65 && UkupnoMirza < 75)
   {
      ocjenaMirza = 7;
   }
   if (UkupnoMirza >= 75 && UkupnoMirza < 85)
   {
      ocjenaMirza = 8;
   }
   if (UkupnoMirza >= 85 && UkupnoMirza < 92)
   {
      ocjenaMirza = 9;
   }
   if (UkupnoMirza >= 92 && UkupnoMirza <= 100)
   {
      ocjenaMirza = 10;
   }
   ...
   if (ocjenaMirza == 5 && ocjenaTarik == 5 && ocjenaBojan == 5)
   {
      return(0);
   }
   if ((ocjenaBojan >= 6 && ocjenaTarik < 6 && ocjenaMirza < 6) || (ocjenaMirza >= 6 && ocjenaTarik < 6 && ocjenaBojan < 6) || (ocjenaTarik >= 6 && ocjenaBojan < 6 && ocjenaMirza < 6))
   {
      return(0);
   }
   if (brojac == 3)

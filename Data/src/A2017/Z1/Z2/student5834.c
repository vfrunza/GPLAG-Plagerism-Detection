...
int main()
{
	double x1,x2,x3,y1,y2,y3,st1,st2,st3,ug1,ug2,ug3;
	int step1,step2,step3,min1,min2,min3,sek1,sek2,sek3;
	...
	if(fabs(ug2-90)<eps || fabs(ug3-90)<eps) printf("Pravougli\n");
	else if(step1==0 || step1==180 || step2==0 || step==180 || step3==0 || step3==180) printf("Linija");

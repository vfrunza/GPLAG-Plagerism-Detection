   ...
   for(i=0;i<n;i++){
        for(j=0;j<n;j++){
            if(i<n/2 && j<n/2){
                ...
                if((j==n/2&& i==0)|| (j==n/2&& i==n/2-1) || (j==n-1&&i==0) || (j==n-1 &&i==n/2-1) )printf("+");
            ...
            if((i==n/2-1+((n/2)/2) ||i==n/2-1+((n/2)/2)+1)&&(j==n/2-1+((n/2)/2)+1 ||j==n/2-1+((n/2)/2)))printf("+");
            else if((j==n/2-1+((n/2)/2)+1 ||j==n/2-1+((n/2)/2)))printf("|");
            else if((i==n/2-1+((n/2)/2)+1 ||i==n/2-1+((n/2)/2)))printf("-");
            else printf(" ");

...
int main() {
	...
	for(i=0; i<n; i++) {
		for(j=0; j<n; j++) {
			...
			else if((j==n/2 && i==0) || (j==n-1 && i==0) || (i==n/2-1 && j==n/2) || (i==n/2-1 && j==n-1)) printf("+");
			...
			else if((j==3*n/4-1&&i==3*n/4-1)||(j==3*n/4&&i==3*n/4-1) || (j==3*n/4-1&&i==3*n/4) || (j==3*n/4&&i==3*n/4)) printf("+");
			else if((i==3*n/4-1&&j>n/2-1)||(i==3*n/4&&j>n/2-1)) printf("-");
			else if((j==3*n/4-1&&i>n/2-1)||(j==3*n/4&&i>n/2-1)) printf("|");
			else printf(" "); 
		}
